...
- feat(build): generate d.ts files (#1916)
...
- feat(i3s): change output coordinate system (#1893)
...
- fix(tiles): update i3s lod logic (#1891)
...
- feat(examples): i3s - calculate summary stats (#1863)
- fix(i3s-attributes): fix picking attributes parsing (#1869)
- fix(tiles): i3s lod logic (#1870)
- chore(deps): bump url-parse from 1.5.1 to 1.5.3 (#1865)
- I3S Building Scene Layer - Enable feature picking (#1864)
- feat(examples): i3s - change deck.gl controller options (#1861)
- fix(examples): i3s - scroll bar (#1859)
- feat(examples): i3s debug - building explorer (#1857)
- chore(examples): i3s - auto-formatting (#1856)
- feat(examples): i3s - show/hide sublayers (#1855)
- Enable tile-picking for Building Scene Layer (#1852)
- feat(examples): i3s - building explorer ui (#1854)
- Add support for Building Scene Layer to I3S App (#1837)
- chore(i3s-app): cleanup code (#1839)
- feat(i3s-debug-app): disable picking for building scene layers (#1844)
- I3S-Debug-App - Add Building Scene Layer Support (#1838)

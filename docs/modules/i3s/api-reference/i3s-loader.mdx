...
<<<<<<< HEAD:docs/modules/i3s/api-reference/i3s-loader.md
<p class="badges">
...
=======
>>>>>>> 9c921f73a (feat(docs): Improvements to examples on docusaurus website):docs/modules/i3s/api-reference/i3s-loader.mdx

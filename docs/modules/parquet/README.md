...
- `ParquetLoader` and `ParquetWriter` are the default wasm-backed Arrow-table APIs. Use `parquet.shape: 'object-row-table'` when row objects are required.

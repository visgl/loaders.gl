...
| quiet                     | \*                        | \*                        | Skip user prompts during conversion. Tile-converter won't stop to wait an action from a user. See details [below](#quiet-mode)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
Use `--quet` option to avoid user prompts during conversion. In some cases, tile-converter stops and wait for an input from a user, for example, asks weither resume conversion or start a new one.

...
| `json.shape`           | [![Website shields.io](https://img.shields.io/badge/From-v5.0-blue.svg?style=flat-square)](http://shields.io) | `'object-row-table' \| 'array-row-table' \| 'arrow-table'` | `undefined` | Requested table shape. Arrow batches freeze their schema from the first non-empty streamed batch. |

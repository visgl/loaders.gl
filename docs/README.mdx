...
loaders.gl is packaged and published as a suite of composable loader modules 
offering consistent APIs and features across file formats, and offers advanced 
features such as running loaders on workers and incremental parsing, 
and all loaders work in both the browser and in Node.js.

By design, other [vis.gl frameworks](https://vis.gl/frameworks) such as 
[**deck.gl**](https://deck.gl) integrate seamlessly with loaders.gl, 
however loaders.gl can be used with any JavaScript application or framework.

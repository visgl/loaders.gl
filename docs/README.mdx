...
loaders.gl can be used with any JavaScript application or framework. Other
[vis.gl frameworks](https://vis.gl/frameworks), such as [**deck.gl**](https://deck.gl), are designed
to integrate seamlessly with loaders.gl.
...
**Format Autodetection** - Applications can specify multiple loaders when parsing a file, and loaders.gl will automatically pick the right loader based on file or URL extensions, MIME types, and initial data bytes.

...
- [`ParquetSourceLoader`](/docs/modules/parquet/api-reference/parquet-source-loader) NEW - adds reusable range-backed Parquet footer metadata and schema access with cancellation and object-version validation.

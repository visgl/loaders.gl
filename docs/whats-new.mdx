...
- **Raster sources** - New experimental `RasterSource` APIs add viewport-driven typed raster loading, with [`GeoTIFFSource`](/docs/modules/geotiff/api-reference/geotiff-source), [`OMETiffSource`](/docs/modules/geotiff/api-reference/ometiff-source), [`RasterSet`](/docs/modules/tiles/api-reference/raster-set), and new GeoTIFF / OME-TIFF website examples.
...
- [`GeoTIFFSource`](/docs/modules/geotiff/api-reference/geotiff-source) NEW - viewport-driven GeoTIFF / COG source that returns typed raster payloads plus CRS and bounds metadata.
- [`OMETiffSource`](/docs/modules/geotiff/api-reference/ometiff-source) NEW - non-geospatial OME-TIFF source for channel-aware 2D plane reads from image pyramids.
...
- **@loaders.gl/mlt** - New [`MLTLoader`](/docs/modules/mlt/api-reference/mlt-loader) and [`MLTSource`](/docs/modules/mlt/api-reference/mlt-source) add support for the [`MapLibre Tile`](/docs/modules/mlt/formats/mlt) format, with a new [MLT website example](/examples/tiles/mlt).

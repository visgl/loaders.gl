...
- **OpenUSD scenes** - The new `@loaders.gl/scene` module provides an experimental `USDLoader` for ASCII USDA layers and uncompressed USDZ archives, including reference and variant composition.

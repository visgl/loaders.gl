...
- **TypeScript improvements** - Typecript v5.6, loader type inference improvements
...
- loader type inference improvements: `load()`, `parse()`, etc now infer correct option and return types when an array of loaders is passed.

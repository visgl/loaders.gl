...
- Geoparquet: support large 'Polygons' and 'MultiPolygons'. Up to 68159 for 'MultiPolygon' and 20062 for 'Polygon' number of vertices tested.
- Many parquet files that previously failed due to size limits now load correctly. 
...
- Render local SLPK in a web browser.

...
- **Coverage expansion and test modernization** - Broad, fast, hermetic Vitest coverage has raised combined line-and-branch coverage from about 70% to over 85% on the path to the long-term 90% goal, while completing the migration of legacy Tape tests to native Vitest syntax.

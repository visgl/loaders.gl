...
- [`ShapefileArrowLoader`](/docs/modules/shapefile/api-reference/shapefile-arrow-loader) NEW - loads Shapefiles into Arrow tables with DBF property columns and a WKB `geometry` column annotated with geospatial schema metadata.

...
- `RADSplatLayer` NEW - renders Spark RAD LoD sources from `RADSourceLoader` through deck.gl/luma.gl without a THREE.js bridge, using paged chunk loading, viewport-driven reselection, and RAD spherical harmonics when present.

...
- [`GeoJSONLoader`](/docs/modules/json/api-reference/geojson-loader) adds GeoArrow WKB Arrow output through `geojson.shape: 'arrow-table'`; [`JSONLoader`](/docs/modules/json/api-reference/json-loader) and [`NDJSONLoader`](/docs/modules/json/api-reference/ndjson-loader) remain generic JSON-to-Arrow loaders.
- [`JSONLoader`](/docs/modules/json/api-reference/json-loader) and [`NDJSONLoader`](/docs/modules/json/api-reference/ndjson-loader) add schema-aware Arrow conversion with strict defaults, optional recovery policies, and one-time recovery logging.

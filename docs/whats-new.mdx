...
- [Binary polygon buffers](/docs/developer-guide/converters/geoarrow-converters#binary-polygon-buffers)
  can now be adapted to math.gl GeoArrow descriptors without copying coordinates. Explicit
  dimensions preserve XYZ/XYM semantics, and row bounds can be computed directly from binary polygons.

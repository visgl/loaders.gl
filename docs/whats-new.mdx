...
- 3DTiles 1.1 Writing
- 3D Tiles 1.1 extensions supported: `EXT_mesh_features`, `EXT_structural_metadata`
- converted `tile-conveter` to TypeScript

**@loaders.gl/tile-converter**

- Removed 'extemded SLPK' usage from the converter, `--slpk` is now a default behavior

...
- `ZipWriter` adds `options.zip.createFolders` <img src="https://img.shields.io/badge/From-v4.4-blue.svg?style=flat-square" alt="From-v4.4" /> to emit parent directory entries for nested file keys.

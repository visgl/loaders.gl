      ...
      options: {
        ...
        EXAMPLES: [
          ...
          },
          {
            ...
            componentUrl: resolve(__dirname, '../examples/website/textures/app.jsx'),
          ...
          },
          {
            ...
            componentUrl: resolve(__dirname, '../examples/website/pointcloud/app.jsx'),
          ...
          },
          {
            ...
            componentUrl: resolve(__dirname, '../examples/website/geospatial/app.jsx'),
          ...
          //   category: "Loaders",
          //   image: 'images/example-geospatial.jpg',
          //   componentUrl: resolve(__dirname, '../examples/website/wms/app.ts'),
          //   path: 'examples/wms'
          // },
          {
            ...
            componentUrl: resolve(__dirname, '../examples/website/3d-tiles/app.jsx'),
          ...
          },
          {
            ...
            componentUrl: resolve(__dirname, '../examples/website/i3s/src/app.jsx'),
            path: 'examples/i3s'
          },
          {
            title: 'I3S Debug',
            category: "Loaders",
            image: 'images/example-i3s.jpg',
            componentUrl: resolve(__dirname, '../examples/website/i3s/src/app-debug.jsx'),
          ...
          },
          {
            ...
            componentUrl: resolve(__dirname, '../examples/benchmarks/app-website.jsx'),

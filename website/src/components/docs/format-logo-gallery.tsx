...
import ogcLogo from '../../../../docs/images/logos/ogc-logo-80.png';
...
const FORMAT_METADATA: ReadonlyArray<FormatMetadata> = [
  ...
  {slug: 'csw', label: 'CSW', logo: ogcLogo, tags: ['geospatial', 'services']},
  ...
  {slug: 'geopackage', label: 'GeoPackage', logo: ogcLogo, tags: ['geospatial']},
  {slug: 'geoparquet', label: 'GeoParquet', logo: 'parquet-logo.png', tags: ['tables', 'geospatial']},
  {slug: 'geotiff', label: 'GeoTIFF', logo: ogcLogo, tags: ['geospatial']},
  ...
  {slug: 'gml', label: 'GML', logo: ogcLogo, tags: ['geospatial']},
  ...
  {slug: 'kml', label: 'KML', logo: ogcLogo, tags: ['geospatial']},
  ...
  {slug: 'ogc-api', label: 'OGC API Services', logo: ogcLogo, tags: ['geospatial', 'services']},
  {slug: 'ows-context', label: 'OWS Context', logo: ogcLogo, tags: ['geospatial', 'services']},
  ...
  {slug: 'wkb', label: 'WKB', logo: ogcLogo, tags: ['geospatial']},
  {slug: 'wkt', label: 'WKT', logo: ogcLogo, tags: ['geospatial']},
  {slug: 'wkt-crs', label: 'WKT-CRS', logo: ogcLogo, tags: ['geospatial']},
  ...
  {slug: 'wcs', label: 'WCS', logo: ogcLogo, tags: ['geospatial', 'services']},
  {slug: 'wfs', label: 'WFS', logo: ogcLogo, tags: ['geospatial', 'services']},
  {slug: 'wmc', label: 'WMC', logo: ogcLogo, tags: ['geospatial', 'services']},
  {slug: 'wms', label: 'WMS', logo: ogcLogo, tags: ['geospatial', 'services']},
  {slug: 'wmts', label: 'WMTS', logo: ogcLogo, tags: ['geospatial', 'services']},

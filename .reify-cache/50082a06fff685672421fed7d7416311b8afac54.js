"use strict";module.export({default:()=>GLBBuilder});var isImage;module.link('@loaders.gl/images',{isImage(v){isImage=v}},0);var packBinaryJson;module.link('../packed-json/pack-binary-json',{default(v){packBinaryJson=v}},1);var padTo4Bytes;module.link('../utils/encode-utils',{padTo4Bytes(v){padTo4Bytes=v}},2);var getAccessorTypeFromSize,getComponentTypeFromArray;module.link('../gltf/gltf-type-utils',{getAccessorTypeFromSize(v){getAccessorTypeFromSize=v},getComponentTypeFromArray(v){getComponentTypeFromArray=v}},3);var copyToArray;module.link('../utils/encode-utils',{copyToArray(v){copyToArray=v}},4);var encodeGLBSync;module.link('../glb/encode-glb',{default(v){encodeGLBSync=v}},5);/* eslint-disable camelcase, max-statements */

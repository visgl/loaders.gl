"use strict";var loadImage;module.link('@loaders.gl/images',{loadImage(v){loadImage=v}},0);var resolvePath;module.link('@loaders.gl/core',{resolvePath(v){resolvePath=v}},1);var test;module.link('tape-promise/tape',{default(v){test=v}},2);var LoadImageWorker;module.link('./load-image.worker',{default(v){LoadImageWorker=v}},3);

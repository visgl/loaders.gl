"use strict";var module1=module;module1.export({LASFile:()=>LASFile});module1.export({LASModuleWasLoaded:()=>LASModuleWasLoaded},true);var getModule;module1.link('./laz-perf',{default(v){getModule=v}},0);/*

"use strict";var test;module.link('tape-promise/tape',{default(v){test=v}},0);var GLTFBuilder,GLTFParser;module.link('@loaders.gl/gltf',{GLTFBuilder(v){GLTFBuilder=v},GLTFParser(v){GLTFParser=v}},1);/* eslint-disable max-len */

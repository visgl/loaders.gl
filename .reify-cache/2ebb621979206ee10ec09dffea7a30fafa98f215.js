"use strict";module.export({createTypedArrayFromAccessor:()=>createTypedArrayFromAccessor});var GLType;module.link('../../math/gl-type',{default(v){GLType=v}},0);var assert;module.link('../../utils/assert',{default(v){assert=v}},1);

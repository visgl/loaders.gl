"use strict";var test;module.link('tape-promise/tape',{default(v){test=v}},0);var toLowPrecision;module.link('test/test-utils',{toLowPrecision(v){toLowPrecision=v}},1);var GLTFBuilder,GLTFParser;module.link('@loaders.gl/gltf',{GLTFBuilder(v){GLTFBuilder=v},GLTFParser(v){GLTFParser=v}},2);var toBuffer;module.link('@loaders.gl/core',{toBuffer(v){toBuffer=v}},3);var CUSTOM_PAYLOAD;module.link('./custom-payload.json',{default(v){CUSTOM_PAYLOAD=v}},4);/* eslint-disable */

"use strict";module.export({isGLB:()=>isGLB,default:()=>parseGLBSync});var TextDecoder,padTo4Bytes,assert;module.link('@loaders.gl/core',{TextDecoder(v){TextDecoder=v},padTo4Bytes(v){padTo4Bytes=v},assert(v){assert=v}},0);/* eslint-disable camelcase, max-statements */
...
function isGLB(dataView, byteOffset = 0, options = {}) {

"use strict";module.export({default:()=>parsePLY});var TextDecoder;module.link('@loaders.gl/core',{TextDecoder(v){TextDecoder=v}},0);var normalizePLY;module.link('./normalize-ply',{default(v){normalizePLY=v}},1);// PLY Loader, adapted from THREE.js (MIT license)
//

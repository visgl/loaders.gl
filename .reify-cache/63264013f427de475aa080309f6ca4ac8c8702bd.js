"use strict";module.export({default:()=>parsePCD});var TextDecoder;module.link('@loaders.gl/core',{TextDecoder(v){TextDecoder=v}},0);// PCD Loader, adapted from THREE.js (MIT license)
//
...
function parsePCD(data, url, options) {

"use strict";module.export({fetchFile:()=>fetchFile,readFileSync:()=>readFileSync,createReadStream:()=>createReadStream});var assert;module.link('../../utils/assert',{default(v){assert=v}},0);/* global fetch */

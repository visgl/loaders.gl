"use strict";module.export({default:()=>encodeGLBSync});var copyPaddedStringToDataView,copyPaddedArrayBufferToDataView;module.link('../utils/encode-utils',{copyPaddedStringToDataView(v){copyPaddedStringToDataView=v},copyPaddedArrayBufferToDataView(v){copyPaddedArrayBufferToDataView=v}},0);/* eslint-disable camelcase, max-statements */
...
function encodeGLBSync(glb, dataView, byteOffset = 0, options = {}) {
  const {magic = MAGIC_glTF, version = 2, json = {}, binary = new ArrayBuffer(0)} = glb;

"use strict";module.export({encode3DTileHeader:()=>encode3DTileHeader,encode3DTileByteLength:()=>encode3DTileByteLength});var assert;module.link('@loaders.gl/core',{assert(v){assert=v}},0);// HELPER ENCODERS

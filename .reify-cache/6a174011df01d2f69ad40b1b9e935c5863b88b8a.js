"use strict";module.export({parseImage:()=>parseImage,loadImage:()=>loadImage,parseToImageBitmap:()=>parseToImageBitmap,loadToHTMLImage:()=>loadToHTMLImage});module.export({canParseImage:()=>canParseImage},true);var global;module.link('../utils/globals',{global(v){global=v}},0);var getImageMetadata;module.link('./get-image-metadata',{getImageMetadata(v){getImageMetadata=v}},1);/* global Image, Blob, createImageBitmap, btoa, fetch */



const canParseImage = global._parseImageNode || typeof ImageBitmap !== 'undefined';

"use strict";module.export({default:()=>Tile3DBatchTableParser});var assert;module.link('../utils/assert',{default(v){assert=v}},0);var createTypedArrayFromAccessor;module.link('./helpers/tile-3d-accessor-utils',{createTypedArrayFromAccessor(v){createTypedArrayFromAccessor=v}},1);var initializeHierarchy,traverseHierarchy;module.link('./tile-3d-batch-table-hierarchy',{initializeHierarchy(v){initializeHierarchy=v},traverseHierarchy(v){traverseHierarchy=v}},2);// import {GL} from '../constants';

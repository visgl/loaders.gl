"use strict";var test;module.link('tape-promise/tape',{default(v){test=v}},0);var isBrowser;module.link('@loaders.gl/core',{isBrowser(v){isBrowser=v}},1);module.link('@loaders.gl/polyfills/');/* global fetch */

"use strict";var test;module.link('tape-promise/tape',{default(v){test=v}},0);var fetchFile,parseSync,encodeSync;module.link('@loaders.gl/core',{fetchFile(v){fetchFile=v},parseSync(v){parseSync=v},encodeSync(v){encodeSync=v}},1);var _getMeshSize;module.link('@loaders.gl/loader-utils',{_getMeshSize(v){_getMeshSize=v}},2);var DracoWriter,DracoLoader;module.link('@loaders.gl/draco',{DracoWriter(v){DracoWriter=v},DracoLoader(v){DracoLoader=v}},3);var validateLoadedData;module.link('test/common/conformance',{validateLoadedData(v){validateLoadedData=v}},4);/* eslint-disable max-len */

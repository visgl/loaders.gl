"use strict";var test;module.link('tape-promise/tape',{default(v){test=v}},0);var GLBBuilder;module.link('@loaders.gl/gltf',{GLBBuilder(v){GLBBuilder=v}},1);var unpackGLBBuffers;module.link('@loaders.gl/gltf/gltf/unpack-gltf-buffers',{default(v){unpackGLBBuffers=v}},2);/* eslint-disable max-len */

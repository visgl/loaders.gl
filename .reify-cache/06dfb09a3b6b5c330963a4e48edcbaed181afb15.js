"use strict";module.export({default:()=>parseComposite3DTileSync});var parse3DTileHeaderSync;module.link('./helpers/parse-3d-tile-header',{parse3DTileHeaderSync(v){parse3DTileHeaderSync=v}},0);

"use strict";var test;module.link('tape-promise/tape',{default(v){test=v}},0);var isBrowser,resolvePath,fetchFile,parse,parseInBatches;module.link('@loaders.gl/core',{isBrowser(v){isBrowser=v},resolvePath(v){resolvePath=v},fetchFile(v){fetchFile=v},parse(v){parse=v},parseInBatches(v){parseInBatches=v}},1);var ArrowLoader;module.link('@loaders.gl/arrow',{ArrowLoader(v){ArrowLoader=v}},2);var ArrowWorkerLoader;module.link('@loaders.gl/arrow',{ArrowWorkerLoader(v){ArrowWorkerLoader=v}},3);

"use strict";module.export({default:()=>GLTFBuilder});var assert;module.link('@loaders.gl/core',{assert(v){assert=v}},0);var getImageSize;module.link('@loaders.gl/images',{getImageSize(v){getImageSize=v}},1);var GLBBuilder;module.link('../deprecated/glb-builder',{default(v){GLBBuilder=v}},2);var packBinaryJson;module.link('../packed-json/pack-binary-json',{default(v){packBinaryJson=v}},3);var KHR_DRACO_MESH_COMPRESSION,UBER_POINT_CLOUD_EXTENSION;module.link('./gltf-constants',{KHR_DRACO_MESH_COMPRESSION(v){KHR_DRACO_MESH_COMPRESSION=v},UBER_POINT_CLOUD_EXTENSION(v){UBER_POINT_CLOUD_EXTENSION=v}},4);





class GLTFBuilder extends GLBBuilder {
  constructor(options = {}) {
    super(options);

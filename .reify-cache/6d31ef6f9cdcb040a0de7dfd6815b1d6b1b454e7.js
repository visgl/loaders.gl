"use strict";module.export({default:()=>parsePLYStream});var lineAsyncIterator,textDecoderAsyncIterator,forEach;module.link('@loaders.gl/core',{lineAsyncIterator(v){lineAsyncIterator=v},textDecoderAsyncIterator(v){textDecoderAsyncIterator=v},forEach(v){forEach=v}},0);var normalizePLY;module.link('./normalize-ply',{default(v){normalizePLY=v}},1);// PLY Loader, adapted from THREE.js (MIT license)
//
...
async function parsePLYStream(iterator, options = {}) {

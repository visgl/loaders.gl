"use strict";module.export({default:()=>parseLAS,parseLASChunked:()=>parseLASChunked});var LASFile;module.link('./laslaz-decoder',{LASFile(v){LASFile=v}},0);// ported and es6-ified from https://github.com/verma/plasio/

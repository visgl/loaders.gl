"use strict";var test;module.link('tape-promise/tape',{default(v){test=v}},0);var isBrowser,fetchFile,readFileSync;module.link('@loaders.gl/core',{isBrowser(v){isBrowser=v},fetchFile(v){fetchFile=v},readFileSync(v){readFileSync=v}},1);

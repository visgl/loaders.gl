"use strict";module.export({default:()=>fetchNode});var fs;module.link('fs',{default(v){fs=v}},0);var http;module.link('http',{default(v){http=v}},1);var https;module.link('https',{default(v){https=v}},2);var util;module.link('util',{default(v){util=v}},3);var toArrayBuffer;module.link('./utils/to-array-buffer.node',{toArrayBuffer(v){toArrayBuffer=v}},4);var decodeDataUri;module.link('./utils/decode-data-uri.node',{default(v){decodeDataUri=v}},5);var concatenateReadStream;module.link('./utils/stream-utils',{concatenateReadStream(v){concatenateReadStream=v}},6);/* global URL */
/* global Buffer */

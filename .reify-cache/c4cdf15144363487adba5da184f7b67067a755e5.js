"use strict";var test;module.link('tape-promise/tape',{default(v){test=v}},0);var encodeSync,fetchFile,parseSync,_getMeshSize;module.link('@loaders.gl/core',{encodeSync(v){encodeSync=v},fetchFile(v){fetchFile=v},parseSync(v){parseSync=v},_getMeshSize(v){_getMeshSize=v}},1);var DracoLoader,DracoWriter,DracoBuilder;module.link('@loaders.gl/draco',{DracoLoader(v){DracoLoader=v},DracoWriter(v){DracoWriter=v},DracoBuilder(v){DracoBuilder=v}},2);var validateLoadedData;module.link('test/common/conformance',{validateLoadedData(v){validateLoadedData=v}},3);/* eslint-disable max-len */

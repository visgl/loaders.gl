"use strict";module.export({default:()=>parsePointCloud3DTile,parseDraco:()=>parseDraco,parseRGB565:()=>parseRGB565,decodeDraco:()=>decodeDraco});var Vector3;module.link('math.gl',{Vector3(v){Vector3=v}},0);var DracoParser;module.link('@loaders.gl/draco',{DracoParser(v){DracoParser=v}},1);var GL;module.link('../math/gl-constants',{default(v){GL=v}},2);var Tile3DFeatureTable;module.link('../classes/tile-3d-feature-table',{default(v){Tile3DFeatureTable=v}},3);var Tile3DBatchTable;module.link('../classes/tile-3d-batch-table',{default(v){Tile3DBatchTable=v}},4);var parse3DTileHeaderSync;module.link('./helpers/parse-3d-tile-header',{parse3DTileHeaderSync(v){parse3DTileHeaderSync=v}},5);var parse3DTileTablesHeaderSync,parse3DTileTablesSync;module.link('./helpers/parse-3d-tile-tables',{parse3DTileTablesHeaderSync(v){parse3DTileTablesHeaderSync=v},parse3DTileTablesSync(v){parse3DTileTablesSync=v}},6);
...
function parsePointCloud3DTile(tile, arrayBuffer, byteOffset, options) {
...
function parseDraco(tile, featureTable, batchTable) {
  let dracoBuffer;

"use strict";module.export({readFile:()=>readFile,readFileObject:()=>readFileObject,readFileSyncBrowser:()=>readFileSyncBrowser});var assert;module.link('../../utils/assert',{default(v){assert=v}},0);// TODO - this file is not tested
...
async function readFileObject(file, options) {

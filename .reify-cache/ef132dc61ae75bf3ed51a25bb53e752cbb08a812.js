"use strict";module.export({default:()=>packBinaryJson});var flattenToTypedArray;module.link('./flatten-to-typed-array',{flattenToTypedArray(v){flattenToTypedArray=v}},0);

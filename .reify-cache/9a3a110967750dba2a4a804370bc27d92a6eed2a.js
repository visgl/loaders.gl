"use strict";var test;module.link('tape-promise/tape',{default(v){test=v}},0);var isBrowser;module.link('@loaders.gl/core',{isBrowser(v){isBrowser=v}},1);var decodeDataUri;module.link('@loaders.gl/core/node/fetch/decode-data-uri',{default(v){decodeDataUri=v}},2);// This code is based on binary-gltf-utils

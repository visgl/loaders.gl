"use strict";module.export({encodeImage:()=>encodeImage});var assert;module.link('../utils/assert',{default(v){assert=v}},0);var global;module.link('../utils/globals',{global(v){global=v}},1);// Image loading/saving for browser

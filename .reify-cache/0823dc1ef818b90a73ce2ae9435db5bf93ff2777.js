"use strict";module.export({default:()=>ArrowTableBatch});var Schema,Field,RecordBatch,Float32Vector,Float32;module.link('apache-arrow',{Schema(v){Schema=v},Field(v){Field=v},RecordBatch(v){RecordBatch=v},Float32Vector(v){Float32Vector=v},Float32(v){Float32=v}},0);var ColumnarTableBatch;module.link('@loaders.gl/experimental',{ColumnarTableBatch(v){ColumnarTableBatch=v}},1);


class ArrowTableBatch extends ColumnarTableBatch {

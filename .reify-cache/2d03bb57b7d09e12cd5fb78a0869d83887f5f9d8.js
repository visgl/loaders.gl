"use strict";module.export({default:()=>GLTFParser});var TextDecoder,fetchFile;module.link('@loaders.gl/core',{TextDecoder(v){TextDecoder=v},fetchFile(v){fetchFile=v}},0);var GLBParser;module.link('../deprecated/glb-parser',{default(v){GLBParser=v}},1);var GLTFPostProcessor;module.link('./gltf-post-processor',{default(v){GLTFPostProcessor=v}},2);var getFullUri;module.link('./gltf-utils',{getFullUri(v){getFullUri=v}},3);var KHR_DRACO_MESH_COMPRESSION,UBER_POINT_CLOUD_EXTENSION;module.link('./gltf-constants',{KHR_DRACO_MESH_COMPRESSION(v){KHR_DRACO_MESH_COMPRESSION=v},UBER_POINT_CLOUD_EXTENSION(v){UBER_POINT_CLOUD_EXTENSION=v}},4);var getGLTFAccessors,getGLTFAccessor;module.link('./gltf-attribute-utils',{getGLTFAccessors(v){getGLTFAccessors=v},getGLTFAccessor(v){getGLTFAccessor=v}},5);

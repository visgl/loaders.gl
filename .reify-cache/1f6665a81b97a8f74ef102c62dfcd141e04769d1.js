"use strict";module.export({getStreamIterator:()=>getStreamIterator});var isBrowser;module.link('../utils/globals',{isBrowser(v){isBrowser=v}},0);var concatenateArrayBuffers;module.link('./memory-copy-utils',{concatenateArrayBuffers(v){concatenateArrayBuffers=v}},1);

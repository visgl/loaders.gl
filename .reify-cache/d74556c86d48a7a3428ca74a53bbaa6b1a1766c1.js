"use strict";var module1=module;module1.export({writeFile:()=>writeFile});var isBrowser;module1.link('@loaders.gl/core',{isBrowser(v){isBrowser=v}},0);// A browser implementation of the Node.js `fs` module's `fs.writeFile` method.

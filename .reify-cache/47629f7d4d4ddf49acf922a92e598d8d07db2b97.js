"use strict";var module1=module;module1.export({default:()=>AsyncIteratorStreamer});var TextDecoder;module1.link('@loaders.gl/core',{TextDecoder(v){TextDecoder=v}},0);var Papa;module1.link('./papaparse',{default(v){Papa=v}},1);// A custom papaparse `Streamer` for async iterators

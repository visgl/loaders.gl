"use strict";module.export({forEach:()=>forEach,concatenateAsyncIterator:()=>concatenateAsyncIterator,textDecoderAsyncIterator:()=>textDecoderAsyncIterator,textEncoderAsyncIterator:()=>textEncoderAsyncIterator,lineAsyncIterator:()=>lineAsyncIterator,numberedLineAsyncIterator:()=>numberedLineAsyncIterator});var concatenateArrayBuffers;module.link('../javascript-utils/memory-copy-utils',{concatenateArrayBuffers(v){concatenateArrayBuffers=v}},0);var TextDecoder,TextEncoder;module.link('../javascript-utils/text-encoding',{TextDecoder(v){TextDecoder=v},TextEncoder(v){TextEncoder=v}},1);

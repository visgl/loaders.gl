...
export default class App extends PureComponent<AppProps, AppState> {
  ...
  private _tile3dLayer: any = null;
  private _tile3dLayerKey: string | null = null;
  ...
  _renderTile3DLayer() {
    ...
    const layerKey = `${format || ''}|${dataUrl}|${ionAccessToken || ''}|${maximumScreenSpaceError || ''}`;
    ...
    if (!this._tile3dLayer || this._tile3dLayerKey !== layerKey) {
      ...
      this._tile3dLayer = new Tile3DSourceLayer({
        id: 'tile-3d-layer',
        data: dataUrl,
        ...
        onTileError: this._onTilesetError
      });
    }
    // Clone the stable source layer so fold uniforms update without reinitializing the tileset.
    return this._tile3dLayer.clone(tileFoldProps);
  }

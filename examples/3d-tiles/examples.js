...
const ADDITIONAL_EXAMPLES = {
  additional: {
    ...
    examples: {
      ...
      'New York Buildings 1 (Cesium Ion 3D Batched)': {ionAssetId: 6193, ionAccessToken: ION_ACCESS_TOKEN_2},
      'New York Buildings 2 (Cesium Ion 3D Batched)': {ionAssetId: 7162, ionAccessToken: ION_ACCESS_TOKEN_2},

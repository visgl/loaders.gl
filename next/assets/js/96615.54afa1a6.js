"use strict";(self.webpackChunkproject_website=self.webpackChunkproject_website||[]).push([["96615"],{64954(e,t,r){r.d(t,{A:()=>tc});var o,a,i=r(25337),n=r(59452),s=r(3459),l=r(9350),c=r(69198),p=r(25799),u=r(84175),f=r(95335),m=r(66925);let d=`\
#ifdef USE_IBL
...
`,fs:"",defines:{SKIN_MAX_JOINTS:20},getUniforms:(e={},t)=>{let{scenegraphsFromGLTF:r}=e;if(!r?.gltf?.skins?.[0])return{jointMatrix:[]};let{inverseBindMatrices:o,joints:a,skeleton:i}=r.gltf.skins[0],n=[],s=o.value.length/16;for(let e=0;e<s;e++){let t=o.value.subarray(16*e,16*e+16);n.push(new M.k(Array.from(t)))}let l=r.gltfNodeIndexToNodeMap.get(i),c={};l.preorderTraversal((e,{worldMatrix:t})=>{c[e.id]=t});let p=new Float32Array(320);for(let e=0;e<20;++e){let t=a[e];if(void 0===t)break;let o=c[r.gltfNodeIndexToNodeMap.get(t).id],i=n[e],s=new M.k().copy(o).multiplyRight(i),l=16*e;for(let e=0;e<16;e++)p[l+e]=s[e]}return{jointMatrix:p}},uniformTypes:{jointMatrix:["mat4x4<f32>",20]}};var z=r(54338);let K=`
struct VertexInputs {
...
`;function X(e,t){let r=t.materialFactory||new k(e,{modules:[R]}),o={...t.parsedPPBRMaterial.uniforms};delete o.camera;let a=Object.fromEntries(Object.entries({...o,...t.parsedPPBRMaterial.bindings}).filter(([e,t])=>{var o;return r.ownsBinding(e)&&((o=t)instanceof U.h||o instanceof H.R||o instanceof O.L||o instanceof V.g||o instanceof N.X)})),i=r.createMaterial({id:t.id,bindings:a});return i.setProps({pbrMaterial:o}),i}var q=r(42528);function W(e){switch(e){case a.CLAMP_TO_EDGE:return"clamp-to-edge";case a.REPEAT:return"repeat";case a.MIRRORED_REPEAT:return"mirror-repeat";default:return}}var Y=r(35567);let J=[Q("baseColor","pbr_baseColorSampler","baseColorTexture",["pbrMetallicRoughness","baseColorTexture"]),Q("metallicRoughness","pbr_metallicRoughnessSampler","metallicRoughnessTexture",["pbrMetallicRoughness","metallicRoughnessTexture"]),Q("normal","pbr_normalSampler","normalTexture",["normalTexture"]),Q("occlusion","pbr_occlusionSampler","occlusionTexture",["occlusionTexture"]),Q("emissive","pbr_emissiveSampler","emissiveTexture",["emissiveTexture"]),Q("specularColor","pbr_specularColorSampler","KHR_materials_specular.specularColorTexture",["extensions","KHR_materials_specular","specularColorTexture"]),Q("specularIntensity","pbr_specularIntensitySampler","KHR_materials_specular.specularTexture",["extensions","KHR_materials_specular","specularTexture"]),Q("transmission","pbr_transmissionSampler","KHR_materials_transmission.transmissionTexture",["extensions","KHR_materials_transmission","transmissionTexture"]),Q("thickness","pbr_thicknessSampler","KHR_materials_volume.thicknessTexture",["extensions","KHR_materials_volume","thicknessTexture"]),Q("clearcoat","pbr_clearcoatSampler","KHR_materials_clearcoat.clearcoatTexture",["extensions","KHR_materials_clearcoat","clearcoatTexture"]),Q("clearcoatRoughness","pbr_clearcoatRoughnessSampler","KHR_materials_clearcoat.clearcoatRoughnessTexture",["extensions","KHR_materials_clearcoat","clearcoatRoughnessTexture"]),Q("clearcoatNormal","pbr_clearcoatNormalSampler","KHR_materials_clearcoat.clearcoatNormalTexture",["extensions","KHR_materials_clearcoat","clearcoatNormalTexture"]),Q("sheenColor","pbr_sheenColorSampler","KHR_materials_sheen.sheenColorTexture",["extensions","KHR_materials_sheen","sheenColorTexture"]),Q("sheenRoughness","pbr_sheenRoughnessSampler","KHR_materials_sheen.sheenRoughnessTexture",["extensions","KHR_materials_sheen","sheenRoughnessTexture"]),Q("iridescence","pbr_iridescenceSampler","KHR_materials_iridescence.iridescenceTexture",["extensions","KHR_materials_iridescence","iridescenceTexture"]),Q("iridescenceThickness","pbr_iridescenceThicknessSampler","KHR_materials_iridescence.iridescenceThicknessTexture",["extensions","KHR_materials_iridescence","iridescenceThicknessTexture"]),Q("anisotropy","pbr_anisotropySampler","KHR_materials_anisotropy.anisotropyTexture",["extensions","KHR_materials_anisotropy","anisotropyTexture"])],Z=new Map(J.map(e=>[e.slot,e]));function Q(e,t,r,o){return{slot:e,binding:t,displayName:r,pathSegments:o,uvSetUniform:`${e}UVSet`,uvTransformUniform:`${e}UVTransform`}}function ee(e){let t=Z.get(e);if(!t)throw Error(`Unknown PBR texture transform slot ${e}`);return t}function et(e){let t=e?.extensions?.KHR_texture_transform;return{offset:t?.offset?[t.offset[0],t.offset[1]]:[0,0],rotation:t?.rotation??0,scale:t?.scale?[t.scale[0],t.scale[1]]:[1,1]}}function er(e){let t=e?.extensions?.KHR_texture_transform;return t?.texCoord??e?.texCoord??0}function eo(e){let t=new Y.d().set(1,0,0,0,1,0,e.offset[0],e.offset[1],1),r=new Y.d().set(Math.cos(e.rotation),Math.sin(e.rotation),0,-Math.sin(e.rotation),Math.cos(e.rotation),0,0,0,1),o=new Y.d().set(e.scale[0],0,0,0,e.scale[1],0,0,0,1);return Array.from(t.multiplyRight(r).multiplyRight(o))}function ea(e,t,r,o){let i={defines:{MANUAL_SRGB:!0,SRGB_FAST_APPROXIMATION:!0},bindings:{},uniforms:{camera:[0,0,0],metallicRoughnessValues:[1,1]},parameters:{},glParameters:{},generatedTextures:[]};i.defines.USE_TEX_LOD=!0;let{imageBasedLightingEnvironment:n}=o;return n&&(i.bindings.pbr_diffuseEnvSampler=n.diffuseEnvSampler.texture,i.bindings.pbr_specularEnvSampler=n.specularEnvSampler.texture,i.bindings.pbr_brdfLUT=n.brdfLutTexture.texture,i.uniforms.IBLenabled=!0,i.uniforms.scaleIBLAmbient=[1,1]),o?.pbrDebug&&(i.defines.PBR_DEBUG=!0,i.uniforms.scaleDiffBaseMR=[0,0,0,0],i.uniforms.scaleFGDSpec=[0,0,0,0]),r.NORMAL&&(i.defines.HAS_NORMALS=!0),r.TANGENT&&o?.useTangents&&(i.defines.HAS_TANGENTS=!0),r.TEXCOORD_0&&(i.defines.HAS_UV=!0),r.TEXCOORD_1&&(i.defines.HAS_UV_1=!0),r.JOINTS_0&&r.WEIGHTS_0&&(i.defines.HAS_SKIN=!0),r.COLOR_0&&(i.defines.HAS_COLORS=!0),o?.imageBasedLightingEnvironment&&(i.defines.USE_IBL=!0),o?.lights&&(i.defines.USE_LIGHTS=!0),t&&(!1!==o.validateAttributes&&function(e,t){let r=ei(e,0);r.length>0&&!t.TEXCOORD_0&&T.R.warn(`glTF material uses ${r.join(", ")} but primitive is missing TEXCOORD_0; textured shading will sample the default UV coordinates`)();let o=ei(e,1);if(o.length>0&&!t.TEXCOORD_1&&T.R.warn(`glTF material uses ${o.join(", ")} with TEXCOORD_1 but primitive is missing TEXCOORD_1; those textures will be skipped`)(),e.unlit||e.extensions?.KHR_materials_unlit||t.NORMAL)return;let a=e.normalTexture?"lit PBR shading with normalTexture":"lit PBR shading";T.R.warn(`glTF primitive is missing NORMAL while using ${a}; shading will fall back to geometric normals`)()}(t,r),function(e,t,r,o,i){if(r.uniforms.unlit=!!(t.unlit||t.extensions?.KHR_materials_unlit),t.pbrMetallicRoughness&&function(e,t,r,o,a){t.baseColorTexture&&en(e,t.baseColorTexture,"pbr_baseColorSampler",r,{featureOptions:{define:"HAS_BASECOLORMAP",enabledUniformName:"baseColorMapEnabled"},gltf:a,attributes:o,textureTransformSlot:"baseColor"}),r.uniforms.baseColorFactor=t.baseColorFactor||[1,1,1,1],t.metallicRoughnessTexture&&en(e,t.metallicRoughnessTexture,"pbr_metallicRoughnessSampler",r,{featureOptions:{define:"HAS_METALROUGHNESSMAP",enabledUniformName:"metallicRoughnessMapEnabled"},gltf:a,attributes:o,textureTransformSlot:"metallicRoughness"});let{metallicFactor:i=1,roughnessFactor:n=1}=t;r.uniforms.metallicRoughnessValues=[i,n]}(e,t.pbrMetallicRoughness,r,o,i),t.normalTexture){en(e,t.normalTexture,"pbr_normalSampler",r,{featureOptions:{define:"HAS_NORMALMAP",enabledUniformName:"normalMapEnabled"},gltf:i,attributes:o,textureTransformSlot:"normal"});let{scale:a=1}=t.normalTexture;r.uniforms.normalScale=a}if(t.occlusionTexture){en(e,t.occlusionTexture,"pbr_occlusionSampler",r,{featureOptions:{define:"HAS_OCCLUSIONMAP",enabledUniformName:"occlusionMapEnabled"},gltf:i,attributes:o,textureTransformSlot:"occlusion"});let{strength:a=1}=t.occlusionTexture;r.uniforms.occlusionStrength=a}switch(r.uniforms.emissiveFactor=t.emissiveFactor||[0,0,0],t.emissiveTexture&&en(e,t.emissiveTexture,"pbr_emissiveSampler",r,{featureOptions:{define:"HAS_EMISSIVEMAP",enabledUniformName:"emissiveMapEnabled"},gltf:i,attributes:o,textureTransformSlot:"emissive"}),function(e,t,r,o,i={}){var n,s,l,c,p;t&&(((n=t).KHR_materials_specular||n.KHR_materials_ior||n.KHR_materials_transmission||n.KHR_materials_volume||n.KHR_materials_clearcoat||n.KHR_materials_sheen||n.KHR_materials_iridescence||n.KHR_materials_anisotropy)&&(r.defines.USE_MATERIAL_EXTENSIONS=!0),function(e,t,r,o,a={}){t&&(t.specularColorFactor&&(r.uniforms.specularColorFactor=t.specularColorFactor),void 0!==t.specularFactor&&(r.uniforms.specularIntensityFactor=t.specularFactor),t.specularColorTexture&&en(e,t.specularColorTexture,"pbr_specularColorSampler",r,{featureOptions:{define:"HAS_SPECULARCOLORMAP",enabledUniformName:"specularColorMapEnabled"},gltf:o,attributes:a,textureTransformSlot:"specularColor"}),t.specularTexture&&en(e,t.specularTexture,"pbr_specularIntensitySampler",r,{featureOptions:{define:"HAS_SPECULARINTENSITYMAP",enabledUniformName:"specularIntensityMapEnabled"},gltf:o,attributes:a,textureTransformSlot:"specularIntensity"}))}(e,t.KHR_materials_specular,r,o,i),s=t.KHR_materials_ior,l=r,s?.ior!==void 0&&(l.uniforms.ior=s.ior),function(e,t,r,o,i={}){t&&(void 0!==t.transmissionFactor&&(r.uniforms.transmissionFactor=t.transmissionFactor),t.transmissionTexture&&en(e,t.transmissionTexture,"pbr_transmissionSampler",r,{featureOptions:{define:"HAS_TRANSMISSIONMAP",enabledUniformName:"transmissionMapEnabled"},gltf:o,attributes:i,textureTransformSlot:"transmission"}),(t.transmissionFactor??0)>0||t.transmissionTexture)&&(T.R.warn("KHR_materials_transmission uses a premultiplied-alpha blending approximation and may require mesh sorting")(),r.parameters.blend=!0,r.parameters.depthWriteEnabled=!1,r.parameters.blendColorOperation="add",r.parameters.blendColorSrcFactor="one",r.parameters.blendColorDstFactor="one-minus-src-alpha",r.parameters.blendAlphaOperation="add",r.parameters.blendAlphaSrcFactor="one",r.parameters.blendAlphaDstFactor="one-minus-src-alpha",r.glParameters.blend=!0,r.glParameters.depthMask=!1,r.glParameters.blendEquation=a.FUNC_ADD,r.glParameters.blendFunc=[a.ONE,a.ONE_MINUS_SRC_ALPHA,a.ONE,a.ONE_MINUS_SRC_ALPHA])}(e,t.KHR_materials_transmission,r,o,i),function(e,t,r,o,a={}){t&&(void 0!==t.thicknessFactor&&(r.uniforms.thicknessFactor=t.thicknessFactor),t.thicknessTexture&&en(e,t.thicknessTexture,"pbr_thicknessSampler",r,{featureOptions:{define:"HAS_THICKNESSMAP"},gltf:o,attributes:a,textureTransformSlot:"thickness"}),void 0!==t.attenuationDistance&&(r.uniforms.attenuationDistance=t.attenuationDistance),t.attenuationColor&&(r.uniforms.attenuationColor=t.attenuationColor))}(e,t.KHR_materials_volume,r,o,i),function(e,t,r,o,a={}){t&&(void 0!==t.clearcoatFactor&&(r.uniforms.clearcoatFactor=t.clearcoatFactor),void 0!==t.clearcoatRoughnessFactor&&(r.uniforms.clearcoatRoughnessFactor=t.clearcoatRoughnessFactor),t.clearcoatTexture&&en(e,t.clearcoatTexture,"pbr_clearcoatSampler",r,{featureOptions:{define:"HAS_CLEARCOATMAP",enabledUniformName:"clearcoatMapEnabled"},gltf:o,attributes:a,textureTransformSlot:"clearcoat"}),t.clearcoatRoughnessTexture&&en(e,t.clearcoatRoughnessTexture,"pbr_clearcoatRoughnessSampler",r,{featureOptions:{define:"HAS_CLEARCOATROUGHNESSMAP",enabledUniformName:"clearcoatRoughnessMapEnabled"},gltf:o,attributes:a,textureTransformSlot:"clearcoatRoughness"}),t.clearcoatNormalTexture&&en(e,t.clearcoatNormalTexture,"pbr_clearcoatNormalSampler",r,{featureOptions:{define:"HAS_CLEARCOATNORMALMAP"},gltf:o,attributes:a,textureTransformSlot:"clearcoatNormal"}))}(e,t.KHR_materials_clearcoat,r,o,i),function(e,t,r,o,a={}){t&&(t.sheenColorFactor&&(r.uniforms.sheenColorFactor=t.sheenColorFactor),void 0!==t.sheenRoughnessFactor&&(r.uniforms.sheenRoughnessFactor=t.sheenRoughnessFactor),t.sheenColorTexture&&en(e,t.sheenColorTexture,"pbr_sheenColorSampler",r,{featureOptions:{define:"HAS_SHEENCOLORMAP",enabledUniformName:"sheenColorMapEnabled"},gltf:o,attributes:a,textureTransformSlot:"sheenColor"}),t.sheenRoughnessTexture&&en(e,t.sheenRoughnessTexture,"pbr_sheenRoughnessSampler",r,{featureOptions:{define:"HAS_SHEENROUGHNESSMAP",enabledUniformName:"sheenRoughnessMapEnabled"},gltf:o,attributes:a,textureTransformSlot:"sheenRoughness"}))}(e,t.KHR_materials_sheen,r,o,i),function(e,t,r,o,a={}){t&&(void 0!==t.iridescenceFactor&&(r.uniforms.iridescenceFactor=t.iridescenceFactor),void 0!==t.iridescenceIor&&(r.uniforms.iridescenceIor=t.iridescenceIor),(void 0!==t.iridescenceThicknessMinimum||void 0!==t.iridescenceThicknessMaximum)&&(r.uniforms.iridescenceThicknessRange=[t.iridescenceThicknessMinimum??100,t.iridescenceThicknessMaximum??400]),t.iridescenceTexture&&en(e,t.iridescenceTexture,"pbr_iridescenceSampler",r,{featureOptions:{define:"HAS_IRIDESCENCEMAP",enabledUniformName:"iridescenceMapEnabled"},gltf:o,attributes:a,textureTransformSlot:"iridescence"}),t.iridescenceThicknessTexture&&en(e,t.iridescenceThicknessTexture,"pbr_iridescenceThicknessSampler",r,{featureOptions:{define:"HAS_IRIDESCENCETHICKNESSMAP"},gltf:o,attributes:a,textureTransformSlot:"iridescenceThickness"}))}(e,t.KHR_materials_iridescence,r,o,i),function(e,t,r,o,a={}){t&&(void 0!==t.anisotropyStrength&&(r.uniforms.anisotropyStrength=t.anisotropyStrength),void 0!==t.anisotropyRotation&&(r.uniforms.anisotropyRotation=t.anisotropyRotation),t.anisotropyTexture&&en(e,t.anisotropyTexture,"pbr_anisotropySampler",r,{featureOptions:{define:"HAS_ANISOTROPYMAP",enabledUniformName:"anisotropyMapEnabled"},gltf:o,attributes:a,textureTransformSlot:"anisotropy"}))}(e,t.KHR_materials_anisotropy,r,o,i),c=t.KHR_materials_emissive_strength,p=r,c?.emissiveStrength!==void 0&&(p.uniforms.emissiveStrength=c.emissiveStrength))}(e,t.extensions,r,i,o),t.alphaMode||"OPAQUE"){case"OPAQUE":break;case"MASK":{let{alphaCutoff:e=.5}=t;r.defines.ALPHA_CUTOFF=!0,r.uniforms.alphaCutoffEnabled=!0,r.uniforms.alphaCutoff=e;break}case"BLEND":var n;T.R.warn("glTF BLEND alphaMode might not work well because it requires mesh sorting")(),(n=r).parameters.blend=!0,n.parameters.blendColorOperation="add",n.parameters.blendColorSrcFactor="src-alpha",n.parameters.blendColorDstFactor="one-minus-src-alpha",n.parameters.blendAlphaOperation="add",n.parameters.blendAlphaSrcFactor="one",n.parameters.blendAlphaDstFactor="one-minus-src-alpha",n.glParameters.blend=!0,n.glParameters.blendEquation=a.FUNC_ADD,n.glParameters.blendFunc=[a.SRC_ALPHA,a.ONE_MINUS_SRC_ALPHA,a.ONE,a.ONE_MINUS_SRC_ALPHA]}}(e,t,i,r,o.gltf)),i}function ei(e,t){let r=[];for(let o of J){let a=function(e,t){let r=e;for(let e of t)if(!(r=r?.[e]))return null;return r}(e,o.pathSegments);a&&er(a)===t&&r.push(o.displayName)}return r}function en(e,t,r,o,i={}){let n,{featureOptions:s={},gltf:l,attributes:c={},textureTransformSlot:p}=i,{define:u,enabledUniformName:f}=s,m=er(t);if(m>1)return void T.R.warn(`Skipping ${String(r)} because ${m} is not supported; only TEXCOORD_0 and TEXCOORD_1 are currently available`)();if(1===m&&!c.TEXCOORD_1)return void T.R.warn(`Skipping ${String(r)} because it requires TEXCOORD_1 but the primitive does not provide TEXCOORD_1`)();let d=function(e,t){if(e.texture||void 0===e.index||!t?.textures)return e;let r=t.textures[e.index];return r?"texture"in r&&r.texture?{...r,...e,texture:r.texture}:"source"in r?{...e,texture:r}:e:e}(t,l),g=d.texture?.source?.image;if(!g)return void T.R.warn(`Skipping unresolved glTF texture for ${String(r)}`)();let h={wrapS:10497,wrapT:10497,minFilter:9729,magFilter:9729,...d?.texture?.sampler},b={id:d.uniformName||d.id,sampler:{addressModeU:W(h.wrapS),addressModeV:W(h.wrapT),magFilter:function(e){switch(e){case a.NEAREST:return"nearest";case a.LINEAR:return"linear";default:return}}(h.magFilter),...function(e){switch(e){case a.NEAREST:return{minFilter:"nearest"};case a.LINEAR:return{minFilter:"linear"};case a.NEAREST_MIPMAP_NEAREST:return{minFilter:"nearest",mipmapFilter:"nearest"};case a.LINEAR_MIPMAP_NEAREST:return{minFilter:"linear",mipmapFilter:"nearest"};case a.NEAREST_MIPMAP_LINEAR:return{minFilter:"nearest",mipmapFilter:"linear"};case a.LINEAR_MIPMAP_LINEAR:return{minFilter:"linear",mipmapFilter:"linear"};default:return{}}}(h.minFilter)}};if(g.compressed)n=function(e,t,r){let o;if(0===(o=Array.isArray(t.data)&&t.data[0]?.data?t.data:"mipmaps"in t&&Array.isArray(t.mipmaps)?t.mipmaps:[]).length||!o[0]?.data)return T.R.warn("createCompressedTexture: compressed image has no valid mip levels, creating fallback")(),es(e,r);let a=o[0],i=a.width??t.width??0,n=a.height??t.height??0;if(i<=0||n<=0)return T.R.warn("createCompressedTexture: base level has invalid dimensions, creating fallback")(),es(e,r);let s=el(a);if(!s)return T.R.warn("createCompressedTexture: compressed image has no textureFormat, creating fallback")(),es(e,r);let l=function(e,t,r){let{blockWidth:o=1,blockHeight:a=1}=q.vz.getInfo(r),i=1;for(let r=1;;r++){let n=Math.max(1,e>>r),s=Math.max(1,t>>r);if(n<o||s<a)break;i++}return i}(i,n,s),c=Math.min(o.length,l),p=1;for(let e=1;e<c;e++){let t=o[e];if(!t.data||t.width<=0||t.height<=0){T.R.warn(`createCompressedTexture: mip level ${e} has invalid data/dimensions, truncating`)();break}let r=el(t);if(r&&r!==s){T.R.warn(`createCompressedTexture: mip level ${e} format '${r}' differs from base '${s}', truncating`)();break}let a=Math.max(1,i>>e),l=Math.max(1,n>>e);if(t.width!==a||t.height!==l){T.R.warn(`createCompressedTexture: mip level ${e} dimensions ${t.width}x${t.height} don't match expected ${a}x${l}, truncating`)();break}p++}let u=e.createTexture({...r,format:s,usage:V.g.TEXTURE|V.g.COPY_DST,width:i,height:n,mipLevels:p,data:a.data});for(let e=1;e<p;e++)u.writeData(o[e].data,{width:o[e].width,height:o[e].height,mipLevel:e});return u}(e,g,b);else{let{width:t,height:r}=e.getExternalImageSize(g);n=e.createTexture({...b,width:t,height:r,data:g})}if(o.bindings[r]=n,u&&(o.defines[u]=!0),f&&(o.uniforms[f]=!0),p){let e=ee(p);o.uniforms[e.uvSetUniform]=m,o.uniforms[e.uvTransformUniform]=eo(et(t))}o.generatedTextures.push(n)}function es(e,t){return e.createTexture({...t,format:"rgba8unorm",width:1,height:1,mipLevels:1})}function el(e){return e.textureFormat}let ec={modelOptions:{},pbrDebug:!1,imageBasedLightingEnvironment:void 0,lights:!0,useTangents:!1,useByteColors:!0};var ep=r(55611);function eu(e){return e.transformAsPoint([0,0,0])}function ef(e){return e.transformDirection([0,0,-1])}var em=r(90986);function ed(e,{input:t,interpolation:r,output:o},a){let i=t[t.length-1];if(!Number.isFinite(i)||i<=0)return o[0]||null;let n=e%i,s=t.findIndex(e=>e>=n);if(s<0)return o[o.length-1]||null;let l=Math.max(0,s-1),c=t[l],p=t[s];switch(r){case"STEP":return o[l];case"LINEAR":if(p>c)return function(e,t,r,o){if("rotation"===e)return new em.P().slerp({start:t,target:r,ratio:o});let a=[];for(let e=0;e<t.length;e++)a[e]=o*r[e]+(1-o)*t[e];return a}(a,o[l],o[s],(n-c)/(p-c));return o[l]||null;case"CUBICSPLINE":if(p>c){let e=o[3*l+1],t=o[3*l+2];return function({p0:e,outTangent0:t,inTangent1:r,p1:o,tDiff:a,ratio:i}){let n=[];for(let s=0;s<e.length;s++){let l=t[s]*a,c=r[s]*a;n[s]=(2*Math.pow(i,3)-3*Math.pow(i,2)+1)*e[s]+(Math.pow(i,3)-2*Math.pow(i,2)+i)*l+(-2*Math.pow(i,3)+3*Math.pow(i,2))*o[s]+(Math.pow(i,3)-Math.pow(i,2))*c}return n}({p0:e,outTangent0:t,inTangent1:o[3*s+0],p1:o[3*s+1],tDiff:p-c,ratio:(n-c)/(p-c)})}return o[3*l+1]||null;default:return T.R.warn(`Interpolation ${r} not supported`)(),null}}class eg{animation;gltfNodeIdToNodeMap;materials;startTime=0;playing=!0;speed=1;materialTextureTransformState=new Map;constructor(e){if(this.animation=e.animation,this.gltfNodeIdToNodeMap=e.gltfNodeIdToNodeMap,this.materials=e.materials||[],this.animation.name||="unnamed",Object.assign(this,e),this.animation.channels.some(e=>"node"!==e.type)&&!this.materials.length)throw Error(`Animation ${this.animation.name} targets materials, but GLTFAnimator was created without a materials array`)}setTime(e){if(!this.playing)return;let t=(e/1e3-this.startTime)*this.speed;this.animation.channels.forEach(e=>{var r,o,a,i,n,s,l,c;let p,u,f,m;if("node"===e.type){let{sampler:r,targetNodeId:o,path:a}=e,i=this.gltfNodeIdToNodeMap.get(o);if(!i)throw Error(`Cannot find animation target node ${o}`);!function(e,{input:t,interpolation:r,output:o},a,i){let n=ed(e,{input:t,interpolation:r,output:o},i);n&&function(e,t,r){switch(t){case"translation":return e.setPosition(r).updateMatrix();case"rotation":return e.setRotation(r).updateMatrix();case"scale":return e.setScale(r).updateMatrix();default:return T.R.warn(`Bad animation path ${t}`)()}}(a,i,n)}(t,r,i,a);return}let d=this.materials[e.targetMaterialIndex];if(!d)throw Error(`Cannot find animation target material ${e.targetMaterialIndex} for ${e.pointer}`);let g=ed(t,e.sampler);g&&("material"===e.type?(r=d,o=e,a=g,m=void 0!==o.component?{[o.property]:(s=(i=r,n=o.property,p=i.shaderInputs.getUniformValues(),Array.isArray(u=p.pbrMaterial?.[n])?[...u]:[]),l=o.component,c=a[0],(f=[...s])[l]=c,f)}:{[o.property]:1===a.length?a[0]:a},r.setProps({pbrMaterial:m})):function(e,t,r,o){var a,i,n,s;let l,c,p,u,f,m=ee(t.textureSlot),d=(i=o,n=e,s=t,(c=(l=i.get(n)||{})[s.textureSlot])||(c={offset:[...s.baseTransform.offset],rotation:s.baseTransform.rotation,scale:[...s.baseTransform.scale]},l[s.textureSlot]=c,i.set(n,l)),c);switch(t.path){case"offset":void 0!==t.component?d.offset[t.component]=r[0]:d.offset=[r[0],r[1]];break;case"rotation":d.rotation=r[0];break;case"scale":void 0!==t.component?d.scale[t.component]=r[0]:d.scale=[r[0],r[1]]}e.setProps({pbrMaterial:{[m.uvTransformUniform]:(a=t.baseTransform,p=new Y.d(eo(a)),u=new Y.d(eo(d)),f=new Y.d(p).invert(),Array.from(u.multiplyRight(f)))}})}(d,e,g,this.materialTextureTransformState))})}}class eh{animations;constructor(e){this.animations=e.animations.map((t,r)=>{let o=t.name||`Animation-${r}`;return new eg({gltfNodeIdToNodeMap:e.gltfNodeIdToNodeMap,materials:e.materials,animation:{name:o,channels:t.channels}})})}animate(e){T.R.warn("GLTFAnimator#animate is deprecated. Use GLTFAnimator#setTime instead")(),this.setTime(e)}setTime(e){this.animations.forEach(t=>t.setTime(e))}getAnimations(){return this.animations}}let eb={supportLevel:"none",comment:"Not currently listed in the luma.gl glTF extension support registry."},ev={KHR_draco_mesh_compression:{supportLevel:"built-in",comment:"Decoded by loaders.gl before luma.gl builds the scenegraph."},EXT_meshopt_compression:{supportLevel:"built-in",comment:"Meshopt-compressed primitives are decoded during load."},KHR_mesh_quantization:{supportLevel:"built-in",comment:"Quantized accessors are unpacked before geometry creation."},KHR_lights_punctual:{supportLevel:"built-in",comment:"Parsed into luma.gl Light objects."},KHR_materials_unlit:{supportLevel:"built-in",comment:"Unlit materials bypass the default lighting path."},KHR_materials_emissive_strength:{supportLevel:"built-in",comment:"Applied by the stock PBR shader."},KHR_texture_basisu:{supportLevel:"built-in",comment:"BasisU / KTX2 textures pass through when the device supports them."},KHR_texture_transform:{supportLevel:"built-in",comment:"UV transforms are applied during load."},EXT_texture_webp:{supportLevel:"loader-only",comment:"Texture source is resolved during load; final support depends on browser and device decode support."},EXT_texture_avif:{supportLevel:"loader-only",comment:"Texture source is resolved during load; final support depends on browser and device decode support."},KHR_materials_specular:{supportLevel:"built-in",comment:"The stock shader now applies specular factors and textures to the dielectric F0 term."},KHR_materials_ior:{supportLevel:"built-in",comment:"The stock shader now drives dielectric reflectance from the glTF IOR value."},KHR_materials_transmission:{supportLevel:"built-in",comment:"The stock shader now applies transmission to the base layer and exposes transparency through alpha, without a scene-color refraction buffer."},KHR_materials_volume:{supportLevel:"built-in",comment:"Thickness and attenuation now tint transmitted light in the stock shader."},KHR_materials_clearcoat:{supportLevel:"built-in",comment:"The stock shader now adds a secondary clearcoat specular lobe."},KHR_materials_sheen:{supportLevel:"built-in",comment:"The stock shader now adds a sheen lobe for cloth-like materials."},KHR_materials_iridescence:{supportLevel:"built-in",comment:"The stock shader now tints specular response with a view-dependent thin-film iridescence approximation."},KHR_materials_anisotropy:{supportLevel:"built-in",comment:"The stock shader now shapes highlights and IBL response with an anisotropy-direction approximation."},KHR_materials_pbrSpecularGlossiness:{supportLevel:"loader-only",comment:"Extension data can be loaded, but it is not translated into the default metallic-roughness material path."},KHR_materials_variants:{supportLevel:"loader-only",comment:"Variant metadata can be loaded, but applications must choose and apply variants."},EXT_mesh_gpu_instancing:{supportLevel:"none",comment:"GPU instancing data is not yet converted into luma.gl instanced draw setup."},KHR_node_visibility:{supportLevel:"none",comment:"Node-visibility animations and toggles are not mapped onto runtime scenegraph state."},KHR_animation_pointer:{supportLevel:"parsed-and-wired",comment:"Selected node TRS, material factor, and KHR_texture_transform offset/rotation/scale pointers are wired to runtime updates; unsupported targets are skipped."},KHR_materials_diffuse_transmission:{supportLevel:"none",comment:"Diffuse-transmission shading is not implemented in the stock PBR shader."},KHR_materials_dispersion:{supportLevel:"none",comment:"Chromatic dispersion is not implemented in the stock PBR shader."},KHR_materials_volume_scatter:{supportLevel:"none",comment:"Volume scattering is not implemented in the stock PBR shader."},KHR_xmp:{supportLevel:"none",comment:"Metadata payloads remain in the loaded glTF, but luma.gl does not interpret them."},KHR_xmp_json_ld:{supportLevel:"none",comment:"Metadata is preserved in the glTF, but luma.gl does not interpret it."},EXT_lights_image_based:{supportLevel:"none",comment:"Use loadPBREnvironment() or custom environment setup instead."},EXT_texture_video:{supportLevel:"none",comment:"Video textures are not created automatically by the stock pipeline."},MSFT_lod:{supportLevel:"none",comment:"Level-of-detail switching is not implemented in the stock scenegraph loader."}};function e_(e,t=[]){for(let r of t)e.add(r)}let eS={SCALAR:1,VEC2:2,VEC3:3,VEC4:4,MAT2:4,MAT3:9,MAT4:16},eR={5120:Int8Array,5121:Uint8Array,5122:Int16Array,5123:Uint16Array,5125:Uint32Array,5126:Float32Array};function eM(e){let t=eR[e.componentType],r=eS[e.type],o=r*e.count,{buffer:a,byteOffset:i=0}=e.bufferView?.data??{};return{typedArray:new t(a,i+(e.byteOffset||0),o),components:r}}function eC(e){switch(e){case"translation":case"rotation":case"scale":case"weights":return e;default:return null}}function ey(e){let t=ex(e);if(t){let e=ev[t]||null;if(e?.supportLevel==="none")return`${t} is referenced by this pointer, but ${e.comment.charAt(0).toLowerCase()}${e.comment.slice(1)}`}return`no runtime target exists for material property "${e.join("/")}"`}function ex(e){let t=e.indexOf("extensions"),r=e[t+1];return t>=0&&r?r:null}function eI(e,t){T.R.warn(`KHR_animation_pointer target ${e} will be skipped because ${t}`)()}function eT(e,t){if(!e)throw Error(t)}function eA(e){if(!e)return{bounds:null,center:[0,0,0],size:[0,0,0],radius:.5,recommendedOrbitDistance:1};let t=[[e[0][0],e[0][1],e[0][2]],[e[1][0],e[1][1],e[1][2]]],r=[t[1][0]-t[0][0],t[1][1]-t[0][1],t[1][2]-t[0][2]],o=[t[0][0]+.5*r[0],t[0][1]+.5*r[1],t[0][2]+.5*r[2]],a=.5*Math.max(r[0],r[1],r[2]),i=Math.max(.5*Math.hypot(r[0],r[1],r[2]),.001);return{bounds:t,center:o,size:r,radius:i,recommendedOrbitDistance:Math.max(Math.max(a,.001)/Math.tan(Math.PI/6)*1.15,1.1*i)}}var eE=r(77933),eP=r(68986);async function eL(e){let t=[];return e.scenes.forEach(e=>{e.traverse(e=>{})}),await eN(()=>t.some(e=>!e.loaded))}async function eN(e){for(;e();)await new Promise(e=>requestAnimationFrame(e))}var eU=r(53439);let eV=Math.PI/180,eO=new Float32Array(16),eH=new Float32Array(12);function eF(e,t,r){let o=t[0]*eV,a=t[1]*eV,i=t[2]*eV,n=Math.sin(i),s=Math.sin(o),l=Math.sin(a),c=Math.cos(i),p=Math.cos(o),u=Math.cos(a),f=r[0],m=r[1],d=r[2];e[0]=f*u*p,e[1]=f*l*p,e[2]=-(f*s),e[3]=m*(-l*c+u*s*n),e[4]=m*(u*c+l*s*n),e[5]=m*p*n,e[6]=d*(l*n+u*s*c),e[7]=d*(-u*n+l*s*c),e[8]=d*p*c}function ew(e){return e[0]=e[0],e[1]=e[1],e[2]=e[2],e[3]=e[4],e[4]=e[5],e[5]=e[6],e[6]=e[8],e[7]=e[9],e[8]=e[10],e[9]=e[12],e[10]=e[13],e[11]=e[14],e.subarray(0,12)}let eB={size:12,accessor:["getOrientation","getScale","getTranslation","getTransformMatrix"],shaderAttributes:{instanceModelMatrixCol0:{size:3,elementOffset:0},instanceModelMatrixCol1:{size:3,elementOffset:3},instanceModelMatrixCol2:{size:3,elementOffset:6},instanceTranslation:{size:3,elementOffset:9}},update(e,{startRow:t,endRow:r}){let{data:o,getOrientation:a,getScale:i,getTranslation:n,getTransformMatrix:s}=this.props,l=Array.isArray(s),c=l&&16===s.length,p=Array.isArray(i),u=Array.isArray(a),f=Array.isArray(n),m=c||!l&&!!s(o[0]);m?e.constant=c:e.constant=u&&p&&f;let d=e.value;if(e.constant){let t;m?(eO.set(s),t=ew(eO)):(eF(t=eH,a,i),t.set(n,9)),e.value=new Float32Array(t)}else{let l=t*e.size,{iterable:g,objectInfo:h}=(0,eU.X)(o,t,r);for(let e of g){let t;(h.index++,m)?(eO.set(c?s:s(e,h)),t=ew(eO)):(eF(t=eH,u?a:a(e,h),p?i:i(e,h)),t.set(f?n:n(e,h),9)),d[l++]=t[0],d[l++]=t[1],d[l++]=t[2],d[l++]=t[3],d[l++]=t[4],d[l++]=t[5],d[l++]=t[6],d[l++]=t[7],d[l++]=t[8],d[l++]=t[9],d[l++]=t[10],d[l++]=t[11]}}}};function ek(e,t){return"cartesian"===t||"meter-offsets"===t||"default"===t&&!e.isGeospatial}let eD=`\
...
`,eG={name:"scenegraph",vs:eD,fs:eD,uniformTypes:{sizeScale:"f32",sizeMinPixels:"f32",sizeMaxPixels:"f32",sceneModelMatrix:"mat4x4<f32>",composeModelMatrix:"f32"}},ez=`\
#version 300 es
...
`,ej=[255,255,255,255],e$={scenegraph:{type:"object",value:null,async:!0},getScene:e=>e&&e.scenes?"object"==typeof e.scene?e.scene:e.scenes[e.scene||0]:e,getAnimator:e=>e&&e.animator,_animations:null,onFirstDraw:{type:"function",value:()=>{}},sizeScale:{type:"number",value:1,min:0},sizeMinPixels:{type:"number",min:0,value:0},sizeMaxPixels:{type:"number",min:0,value:Number.MAX_SAFE_INTEGER},getPosition:{type:"accessor",value:e=>e.position},getColor:{type:"accessor",value:ej},_lighting:"flat",_imageBasedLightingEnvironment:void 0,getOrientation:{type:"accessor",value:[0,0,0]},getScale:{type:"accessor",value:[1,1,1]},getTranslation:{type:"accessor",value:[0,0,0]},getTransformMatrix:{type:"accessor",value:[]},loaders:[eE.B]};class eX extends p.A{getShaders(){let e,t={};"pbr"===this.props._lighting?(e=R,t.LIGHTING_PBR=1):e={name:"pbrMaterial"};let r=[u.A,f.A,eG,e];return super.getShaders({defines:t,vs:ez,fs:eK,modules:r})}initializeState(){this.getAttributeManager().addInstanced({instancePositions:{size:3,type:"float64",fp64:this.use64bitPositions(),accessor:"getPosition",transition:!0},instanceColors:{type:"unorm8",size:this.props.colorFormat.length,accessor:"getColor",defaultValue:ej,transition:!0},instanceModelMatrix:eB})}updateState(e){super.updateState(e);let{props:t,oldProps:r}=e;t.scenegraph!==r.scenegraph?this._updateScenegraph():t._animations!==r._animations&&this._applyAnimationsProp(this.state.animator,t._animations)}finalizeState(e){super.finalizeState(e),this._destroyScenegraphAssets()}get isLoaded(){return!!(this.state?.scenegraph&&super.isLoaded)}_updateScenegraph(){let e=this.props,{device:t}=this.context,r=null;if(e.scenegraph instanceof I)r={scenes:[e.scenegraph]};else if(e.scenegraph&&"object"==typeof e.scenegraph){let o=e.scenegraph,n=function(e,t,r){var o;let n,s,l,c,{scenes:p,materials:u,gltfMeshIdToNodeMap:f,gltfNodeIdToNodeMap:m,gltfNodeIndexToNodeMap:d}=function(e,t,r={}){let o={...ec,...r},n=new k(e,{modules:[R]}),s=(t.materials||[]).map((r,a)=>{var i,s;return X(e,{id:(i=r,s=a,i.name||i.id||`material-${s}`),parsedPPBRMaterial:ea(e,r,{},{...o,gltf:t,validateAttributes:!1}),materialFactory:n})}),l=new Map;(t.materials||[]).forEach((e,t)=>{l.set(e.id,s[t])});let c=new Map;t.meshes.forEach((r,n)=>{var s,p,u,f,m;let d,g=(s=e,p=r,u=t,f=l,m=o,d=(p.primitives||[]).map((e,t)=>(function({device:e,gltfPrimitive:t,primitiveIndex:r,gltfMesh:o,gltf:n,gltfMaterialIdToMaterialMap:s,options:l}){let c=t.name||`${o.name||o.id}-primitive-${r}`,p=function(e){switch(e){case a.POINTS:return"point-list";case a.LINES:return"line-list";case a.LINE_STRIP:return"line-strip";case a.TRIANGLES:return"triangle-list";case a.TRIANGLE_STRIP:return"triangle-strip";default:throw Error(String(e))}}(t.mode??4),u=t.indices?t.indices.count:function(e){let t=1/0;for(let r of Object.values(e))if(r){let{value:e,size:o,components:a}=r,i=o??a;e?.length!==void 0&&i>=1&&(t=Math.min(t,e.length/i))}if(!Number.isFinite(t))throw Error("Could not determine vertex count from attributes");return t}(t.attributes),f=function(e,t,r){let o={};for(let[e,r]of Object.entries(t.attributes)){let{components:t,size:a,value:i,normalized:n}=r;o[e]={size:a??t,value:i,normalized:n}}return new i.V({id:e,topology:r,indices:t.indices?.value,attributes:o})}(c,t,p),m=ea(e,t.material,f.attributes,{...l,gltf:n}),d=function(e,t){let{id:r,geometry:o,parsedPPBRMaterial:a,vertexCount:i,modelOptions:n={}}=t;T.R.info(4,"createGLTFModel defines: ",a.defines)();let s={id:r,source:K,vs:j,fs:$,geometry:o,topology:o.topology,vertexCount:i,modules:[R,G],...n,defines:{...a.defines,...n.defines},parameters:{depthWriteEnabled:!0,depthCompare:"less",depthFormat:"depth24plus",cullMode:"back",...a.parameters,...n.parameters}},l=t.material||X(e,{id:r?`${r}-material`:void 0,parsedPPBRMaterial:a});s.material=l;let c=new z.K(e,s),p={...a.uniforms,...n.uniforms,...a.bindings,...n.bindings},u=function(e,t,r){let o=new Map;for(let t of e){for(let e of Object.keys(t.uniformTypes||{}))o.set(e,t.name);for(let e of t.bindingLayout||[])o.set(e.name,t.name)}let a={};for(let[e,i]of Object.entries(r)){if(void 0===i)continue;let r=o.get(e);!r||t.ownsModule(r)||(a[r]||={},a[r][e]=i)}return a}(c.shaderInputs.getModules(),l,p);return c.shaderInputs.setProps(u),new E({managedResources:[],model:c})}(e,{id:c,geometry:f,material:t.material&&s.get(t.material.id)||null,parsedPPBRMaterial:m,modelOptions:l.modelOptions,vertexCount:u});return d.bounds=[t.attributes.POSITION.min,t.attributes.POSITION.max],d})({device:s,gltfPrimitive:e,primitiveIndex:t,gltfMesh:p,gltf:u,gltfMaterialIdToMaterialMap:f,options:m})),new A({id:p.name||p.id,children:d}));c.set(r.id,g)});let p=new Map,u=new Map;return t.nodes.forEach((e,t)=>{var r;let o=new A({id:(r=e).name||r.id,children:[],matrix:r.matrix,position:r.translation,rotation:r.rotation,scale:r.scale});p.set(t,o),u.set(e.id,o)}),t.nodes.forEach((e,t)=>{if(p.get(t).add((e.children??[]).map(({id:e})=>{let r=u.get(e);if(!r)throw Error(`Cannot find child ${e} of node ${t}`);return r})),e.mesh){let r=c.get(e.mesh.id);if(!r)throw Error(`Cannot find mesh child ${e.mesh.id} of node ${t}`);p.get(t).add(r)}}),{scenes:t.scenes.map(e=>{let t=(e.nodes||[]).map(({id:t})=>{let r=u.get(t);if(!r)throw Error(`Cannot find child ${t} of scene ${e.name||e.id}`);return r});return new A({id:e.name||e.id,children:t})}),materials:s,gltfMeshIdToNodeMap:c,gltfNodeIdToNodeMap:u,gltfNodeIndexToNodeMap:p}}(e,t,r),g=new eh({animations:(s=t.animations||[],l=new Map,c=new Map,s.flatMap((e,r)=>{let o=e.name||`Animation-${r}`,a=new Map,i=e.channels.flatMap(({sampler:r,target:o})=>{let i=a.get(r);if(!i){let o=e.samplers[r];if(!o)throw Error(`Cannot find animation sampler ${r}`);let{input:n,interpolation:s="LINEAR",output:p}=o;i={input:function(e,t){if(t.has(e))return t.get(e);let{typedArray:r,components:o}=eM(e);eT(1===o,"accessorToJsArray1D must have exactly 1 component");let a=Array.from(r);return t.set(e,a),a}(t.accessors[n],l),interpolation:s,output:function(e,t){if(t.has(e))return t.get(e);let{typedArray:r,components:o}=eM(e);eT(o>=1,"accessorToJsArray2D must have at least 1 component");let a=[];for(let e=0;e<r.length;e+=o)a.push(Array.from(r.slice(e,e+o)));return t.set(e,a),a}(t.accessors[p],c)},a.set(r,i)}let n=function(e,t,r){if("pointer"===t.path)return function(e,t,r){let o=t.extensions?.KHR_animation_pointer?.pointer;if("string"!=typeof o||!o.startsWith("/"))return T.R.warn("KHR_animation_pointer channel is missing a valid JSON pointer and will be skipped")(),null;let a=o.slice(1).split("/").map(e=>e.replace(/~1/g,"/").replace(/~0/g,"~"));switch(a[0]){case"nodes":var i=e,n=a,s=r,l=o;if(3!==n.length)return eI(l,"node pointers must use /nodes/{index}/{translation|rotation|scale|weights}"),null;let c=Number(n[1]),p=i.nodes[c];if(!Number.isInteger(c)||!p)return T.R.warn(`KHR_animation_pointer target ${l} references a missing node and will be skipped`)(),null;let u=eC(n[2]);return u?"weights"===u?(T.R.warn(`KHR_animation_pointer target ${l} will be skipped because morph weights are not implemented in GLTFAnimator`)(),null):{type:"node",sampler:s,targetNodeId:p.id,path:u}:(eI(l,`node property "${n[2]}" has no runtime animation mapping`),null);case"materials":var f=e,m=a,d=r,g=o;if(m.length<3)return eI(g,"material pointers must include a material index and target property path"),null;let h=Number(m[1]),b=f.materials[h];if(!Number.isInteger(h)||!b)return T.R.warn(`KHR_animation_pointer target ${g} references a missing material and will be skipped`)(),null;let v=function(e,t){let r=function(e,t){var r;let o,a=t.lastIndexOf("extensions");if(a<0||"KHR_texture_transform"!==t[a+1]||a<1)return{reason:"not-a-texture-transform-target"};let i=(r=t.slice(0,a),J.find(e=>e.pathSegments.length===r.length&&e.pathSegments.every((e,t)=>r[t]===e))||null);if(!i)return{reason:function(e){let t=ex(e);if(t){let e=ev[t]||null;if(e?.supportLevel==="none")return`${t} is referenced by this pointer, but ${e.comment.charAt(0).toLowerCase()}${e.comment.slice(1)}`}return`texture-transform target "${e.join("/")}" has no runtime texture-slot mapping`}(t.slice(0,a))};let n=function(e,t){let r=e;for(let e of t)if(!(r=r?.[e]))return null;return r}(e,i.pathSegments);if(!n)return{reason:`texture-transform target "${t.slice(0,a).join("/")}" does not exist on the referenced material`};let s=t[a+2];if("texCoord"===s)return{reason:"animated KHR_texture_transform.texCoord is unsupported because texCoord selection is structural, not a runtime float/vector update"};if("offset"!==s&&"rotation"!==s&&"scale"!==s)return{reason:`KHR_texture_transform property "${s}" is not animatable; supported properties are offset, rotation, and scale`};let l=t[a+3];if(t.length>a+4)return{reason:`KHR_texture_transform.${s} does not support nested property paths`};if(void 0!==l){if(o=Number(l),"rotation"===s)return{reason:"KHR_texture_transform.rotation does not support component indices"};if(!Number.isInteger(o)||o<0||o>1)return{reason:`KHR_texture_transform.${s} component index "${l}" is invalid; only 0 and 1 are supported`}}return{type:"textureTransform",textureSlot:i.slot,path:s,component:o,baseTransform:et(n)}}(e,t);if(!("reason"in r)||"not-a-texture-transform-target"!==r.reason)return r;switch(t.join("/")){case"pbrMetallicRoughness/baseColorFactor":return e.pbrMetallicRoughness?{type:"material",property:"baseColorFactor"}:{reason:ey(t)};case"pbrMetallicRoughness/metallicFactor":return e.pbrMetallicRoughness?{type:"material",property:"metallicRoughnessValues",component:0}:{reason:ey(t)};case"pbrMetallicRoughness/roughnessFactor":return e.pbrMetallicRoughness?{type:"material",property:"metallicRoughnessValues",component:1}:{reason:ey(t)};case"normalTexture/scale":return e.normalTexture?{type:"material",property:"normalScale"}:{reason:ey(t)};case"occlusionTexture/strength":return e.occlusionTexture?{type:"material",property:"occlusionStrength"}:{reason:ey(t)};case"emissiveFactor":return{type:"material",property:"emissiveFactor"};case"alphaCutoff":return{type:"material",property:"alphaCutoff"};case"extensions/KHR_materials_specular/specularFactor":return e.extensions?.KHR_materials_specular?{type:"material",property:"specularIntensityFactor"}:{reason:ey(t)};case"extensions/KHR_materials_specular/specularColorFactor":return e.extensions?.KHR_materials_specular?{type:"material",property:"specularColorFactor"}:{reason:ey(t)};case"extensions/KHR_materials_ior/ior":return e.extensions?.KHR_materials_ior?{type:"material",property:"ior"}:{reason:ey(t)};case"extensions/KHR_materials_transmission/transmissionFactor":return e.extensions?.KHR_materials_transmission?{type:"material",property:"transmissionFactor"}:{reason:ey(t)};case"extensions/KHR_materials_volume/thicknessFactor":return e.extensions?.KHR_materials_volume?{type:"material",property:"thicknessFactor"}:{reason:ey(t)};case"extensions/KHR_materials_volume/attenuationDistance":return e.extensions?.KHR_materials_volume?{type:"material",property:"attenuationDistance"}:{reason:ey(t)};case"extensions/KHR_materials_volume/attenuationColor":return e.extensions?.KHR_materials_volume?{type:"material",property:"attenuationColor"}:{reason:ey(t)};case"extensions/KHR_materials_clearcoat/clearcoatFactor":return e.extensions?.KHR_materials_clearcoat?{type:"material",property:"clearcoatFactor"}:{reason:ey(t)};case"extensions/KHR_materials_clearcoat/clearcoatRoughnessFactor":return e.extensions?.KHR_materials_clearcoat?{type:"material",property:"clearcoatRoughnessFactor"}:{reason:ey(t)};case"extensions/KHR_materials_sheen/sheenColorFactor":return e.extensions?.KHR_materials_sheen?{type:"material",property:"sheenColorFactor"}:{reason:ey(t)};case"extensions/KHR_materials_sheen/sheenRoughnessFactor":return e.extensions?.KHR_materials_sheen?{type:"material",property:"sheenRoughnessFactor"}:{reason:ey(t)};case"extensions/KHR_materials_iridescence/iridescenceFactor":return e.extensions?.KHR_materials_iridescence?{type:"material",property:"iridescenceFactor"}:{reason:ey(t)};case"extensions/KHR_materials_iridescence/iridescenceIor":return e.extensions?.KHR_materials_iridescence?{type:"material",property:"iridescenceIor"}:{reason:ey(t)};case"extensions/KHR_materials_iridescence/iridescenceThicknessMinimum":return e.extensions?.KHR_materials_iridescence?{type:"material",property:"iridescenceThicknessRange",component:0}:{reason:ey(t)};case"extensions/KHR_materials_iridescence/iridescenceThicknessMaximum":return e.extensions?.KHR_materials_iridescence?{type:"material",property:"iridescenceThicknessRange",component:1}:{reason:ey(t)};case"extensions/KHR_materials_anisotropy/anisotropyStrength":return e.extensions?.KHR_materials_anisotropy?{type:"material",property:"anisotropyStrength"}:{reason:ey(t)};case"extensions/KHR_materials_anisotropy/anisotropyRotation":return e.extensions?.KHR_materials_anisotropy?{type:"material",property:"anisotropyRotation"}:{reason:ey(t)};case"extensions/KHR_materials_emissive_strength/emissiveStrength":return e.extensions?.KHR_materials_emissive_strength?{type:"material",property:"emissiveStrength"}:{reason:ey(t)};default:return{reason:ey(t)}}}(b,m.slice(2));return"reason"in v?(eI(g,v.reason),null):{sampler:d,pointer:g,targetMaterialIndex:h,...v};default:return eI(o,`top-level target "${a[0]}" has no runtime animation mapping`),null}}(e,t,r);let o=eC(t.path);if(!o)return null;let a=e.nodes[t.node??0];if(!a)throw Error(`Cannot find animation target ${t.node}`);return{type:"node",sampler:r,targetNodeId:a.id,path:o}}(t,o,i);return n?[n]:[]});return i.length?[{name:o,channels:i}]:[]})),gltfNodeIdToNodeMap:m,materials:u}),h=function(e,t={}){let r=e.lights||e.extensions?.KHR_lights_punctual?.lights;if(!r||!Array.isArray(r)||0===r.length)return[];let o=[],a=function(e){let t=new Map;for(let r of e)for(let e of r.children||[])t.set(e.id,r);return t}(e.nodes||[]),i=new Map;for(let p of e.nodes||[]){var n,s,l,c;let e=p.light??p.extensions?.KHR_lights_punctual?.light;if("number"!=typeof e)continue;let u=r[e];if(!u)continue;let f=(n=u.color||[1,1,1],t.useByteColors??!0?n.map(e=>255*e):(0,ep.sC)(n,!1)),m=u.intensity??1,d=u.range,g=function e(t,r,o){let a=o.get(t.id);if(a)return a;let i=function(e){if(e.matrix)return new M.k(e.matrix);let t=new M.k;return e.translation&&t.translate(e.translation),e.rotation&&t.multiplyRight(new M.k().fromQuaternion(e.rotation)),e.scale&&t.scale(e.scale),t}(t),n=r.get(t.id),s=n?new M.k(e(n,r,o)).multiplyRight(i):i;return o.set(t.id,s),s}(p,a,i);switch(u.type){case"directional":o.push((s=g,l=f,c=m,{type:"directional",direction:ef(s),color:l,intensity:c}));break;case"point":o.push(function(e,t,r,o){let a=eu(e),i=[1,0,0];return void 0!==o&&o>0&&(i=[1,0,1/(o*o)]),{type:"point",position:a,color:t,intensity:r,attenuation:i}}(g,f,m,d));break;case"spot":o.push(function(e,t,r,o,a={}){let i=eu(e),n=ef(e),s=[1,0,0];return void 0!==o&&o>0&&(s=[1,0,1/(o*o)]),{type:"spot",position:i,direction:n,color:t,intensity:r,attenuation:s,innerConeAngle:a.innerConeAngle??0,outerConeAngle:a.outerConeAngle??Math.PI/4}}(g,f,m,d,u.spot))}}return o}(t,{useByteColors:r?.useByteColors??!0}),b=new Map(Array.from((o=t,e_(n=new Set,o.extensionsUsed),e_(n,o.extensionsRequired),e_(n,o.extensionsRemoved),e_(n,Object.keys(o.extensions||{})),(o.lights?.length||(o.nodes||[]).some(e=>"light"in e))&&n.add("KHR_lights_punctual"),(o.materials||[]).some(e=>e.unlit||e.extensions?.KHR_materials_unlit)&&n.add("KHR_materials_unlit"),n)).sort().map(e=>{let t=ev[e]||eb;return[e,{extensionName:e,supported:"built-in"===t.supportLevel||"parsed-and-wired"===t.supportLevel,supportLevel:t.supportLevel,comment:t.comment}]})),v=p.map(e=>eA(e.getBounds())),_=function(e){let t=null;for(let r of e)if(r.bounds){if(!t){t=[[...r.bounds[0]],[...r.bounds[1]]];continue}for(let e=0;e<3;e++)t[0][e]=Math.min(t[0][e],r.bounds[0][e]),t[1][e]=Math.max(t[1][e],r.bounds[1][e])}return eA(t)}(v);return{scenes:p,materials:u,animator:g,lights:h,extensionSupport:b,sceneBounds:v,modelBounds:_,gltfMeshIdToNodeMap:f,gltfNodeIdToNodeMap:m,gltfNodeIndexToNodeMap:d,gltf:t}}(t,o.json?(0,eP.R)(o):o,this._getModelOptions());r=n,eL(n).then(()=>this.setNeedsRedraw()).catch(e=>{this.raiseError(e,"loading glTF")})}let o={layer:this,device:this.context.device},n=e.getScene(r,o),l=e.getAnimator(r,o);if(n instanceof A){this._destroyScenegraphAssets(),this._applyAnimationsProp(l,e._animations);let t=[];n.traverse(e=>{e instanceof E&&t.push(e.model)}),this.setState({scenegraph:n,animator:l,materials:r?.materials||null,models:t,firstDrawSignaled:!1}),this.getAttributeManager().invalidateAll()}else null!==n&&s.A.warn("invalid scenegraph:",n)()}_destroyScenegraphAssets(){this.state.scenegraph?.destroy(),this.state.materials?.forEach(e=>e.destroy()),this.state.scenegraph=null,this.state.animator=null,this.state.materials=null,this.state.models=[]}_applyAnimationsProp(e,t){if(!e||!t)return;let r=e.getAnimations();Object.keys(t).sort().forEach(e=>{let o=t[e];if("*"===e)r.forEach(e=>{Object.assign(e,o)});else if(Number.isFinite(Number(e))){let t=Number(e);t>=0&&t<r.length?Object.assign(r[t],o):s.A.warn(`animation ${e} not found`)()}else{let t=r.find(({animation:t})=>t.name===e);t?Object.assign(t,o):s.A.warn(`animation ${e} not found`)()}})}_getModelOptions(){let e,{_imageBasedLightingEnvironment:t}=this.props;return t&&(e="function"==typeof t?t({gl:this.context.gl,layer:this}):t),{imageBasedLightingEnvironment:e,modelOptions:{id:this.props.id,isInstanced:!0,bufferLayout:this.getAttributeManager().getBufferLayouts(),...this.getShaders()},useTangents:!1}}draw({context:e}){if(!this.state.scenegraph)return;this.props._animations&&this.state.animator&&(this.state.animator.setTime(e.timeline.getTime()),this.setNeedsRedraw());let{viewport:t,renderPass:r}=this.context,{sizeScale:o,sizeMinPixels:a,sizeMaxPixels:i,coordinateSystem:n}=this.props,s={camera:t.cameraPosition},l=this.getNumInstances();this.state.scenegraph.traverse((e,{worldMatrix:c})=>{if(e instanceof E){let{model:p}=e;p.setInstanceCount(l);let u={sizeScale:o,sizeMinPixels:a,sizeMaxPixels:i,composeModelMatrix:ek(t,n),sceneModelMatrix:c};p.shaderInputs.setProps({pbrProjection:s,scenegraph:u}),p.draw(r)}}),this.state.firstDrawSignaled||(this.state.firstDrawSignaled=!0,this.props.onFirstDraw?.())}}eX.defaultProps=e$,eX.layerName="ScenegraphLayer";var eq=r(98881),eW=r(79439),eY=r(38846);let eJ={name:"phongMaterial",firstBindingSlot:0,bindingLayout:[{name:"phongMaterial",group:3}],dependencies:[m.x,eq.$],source:eW.X,vs:eY.X,fs:eY.l,defines:{LIGHTING_FRAGMENT:!0},uniformTypes:{unlit:"i32",ambient:"f32",diffuse:"f32",shininess:"f32",specularColor:"vec3<f32>"},defaultUniforms:{unlit:!1,ambient:.35,diffuse:.6,shininess:32,specularColor:[38.25,38.25,38.25]},getUniforms:e=>({...eJ.defaultUniforms,...e})},eZ=`\
...
`,eQ={name:"simpleMesh",vs:eZ,fs:eZ,uniformTypes:{sizeScale:"f32",composeModelMatrix:"f32",hasTexture:"f32",flatShading:"f32"}},e0=`#version 300 es
...
`;var e1=r(67916);function e2(e){let t=e.positions||e.POSITION;s.A.assert(t,'no "postions" or "POSITION" attribute in mesh');let r=t.value.length/t.size,o=e.COLOR_0||e.colors;o||(o={size:3,value:new Float32Array(3*r).fill(1)});let a=e.NORMAL||e.normals;a||(a={size:3,value:new Float32Array(3*r).fill(0)});let i=e.TEXCOORD_0||e.texCoords;return i||(i={size:2,value:new Float32Array(2*r).fill(0)}),{positions:t,colors:o,normals:a,texCoords:i}}function e4(e){return e instanceof i.V?(e.attributes=e2(e.attributes),e):new i.V(e.attributes?{...e,topology:"triangle-list",attributes:e2(e.attributes)}:{topology:"triangle-list",attributes:e2(e)})}class e5 extends p.A{getShaders(){return super.getShaders({vs:e0,fs:e3,modules:[u.A,eJ,f.A,eQ]})}getBounds(){if(this.props._instanced)return super.getBounds();let e=this.state.positionBounds;if(e)return e;let{mesh:t}=this.props;if(!t)return null;if(!(e=t.header?.boundingBox)){let{attributes:r}=e4(t);r.POSITION=r.POSITION||r.positions,e=(0,e1.l)(r)}return this.state.positionBounds=e,e}initializeState(){this.getAttributeManager().addInstanced({instancePositions:{transition:!0,type:"float64",fp64:this.use64bitPositions(),size:3,accessor:"getPosition"},instanceColors:{type:"unorm8",transition:!0,size:this.props.colorFormat.length,accessor:"getColor",defaultValue:[0,0,0,255]},instanceModelMatrix:eB}),this.setState({emptyTexture:this.context.device.createTexture({data:new Uint8Array(4),width:1,height:1})})}updateState(e){super.updateState(e);let{props:t,oldProps:r,changeFlags:o}=e;if(t.mesh!==r.mesh||o.extensionsChanged){if(this.state.positionBounds=null,this.state.model?.destroy(),t.mesh){this.state.model=this.getModel(t.mesh);let e=t.mesh.attributes||t.mesh;this.setState({hasNormals:!!(e.NORMAL||e.normals)})}this.getAttributeManager().invalidateAll()}t.texture!==r.texture&&t.texture instanceof V.g&&this.setTexture(t.texture),this.state.model&&this.state.model.setTopology(this.props.wireframe?"line-strip":"triangle-list")}finalizeState(e){super.finalizeState(e),this.state.emptyTexture.delete()}draw({uniforms:e}){let{model:t}=this.state;if(!t)return;let{viewport:r,renderPass:o}=this.context,{sizeScale:a,coordinateSystem:i,_instanced:n}=this.props,s={sizeScale:a,composeModelMatrix:!n||ek(r,i),flatShading:!this.state.hasNormals};t.shaderInputs.setProps({simpleMesh:s}),t.draw(o)}get isLoaded(){return!!(this.state?.model&&super.isLoaded)}getModel(e){let t=new z.K(this.context.device,{...this.getShaders(),id:this.props.id,bufferLayout:this.getAttributeManager().getBufferLayouts(),geometry:e4(e),isInstanced:!0}),{texture:r}=this.props,{emptyTexture:o}=this.state;return t.shaderInputs.setProps({simpleMesh:{sampler:r||o,hasTexture:!!r}}),t}setTexture(e){let{emptyTexture:t,model:r}=this.state;r&&r.shaderInputs.setProps({simpleMesh:{sampler:e||t,hasTexture:!!e}})}}e5.defaultProps={mesh:{type:"object",value:null,async:!0},texture:{type:"image",value:null,async:!0},sizeScale:{type:"number",value:1,min:0},_instanced:!0,wireframe:!1,material:!0,getPosition:{type:"accessor",value:e=>e.position},getColor:{type:"accessor",value:[0,0,0,255]},getOrientation:{type:"accessor",value:[0,0,0]},getScale:{type:"accessor",value:[1,1,1]},getTranslation:{type:"accessor",value:[0,0,0]},getTransformMatrix:{type:"accessor",value:[]},textureParameters:{type:"object",ignore:!0,value:null}},e5.layerName="SimpleMeshLayer";let e9=e5,e6=`\
layout(std140) uniform meshUniforms {
  bool pickFeatureIds;
} mesh;
`,e8={name:"mesh",vs:e6,fs:e6,uniformTypes:{pickFeatureIds:"f32"}},e7=`#version 300 es
#define SHADER_NAME simple-mesh-layer-vs
in vec3 positions;
in vec3 normals;
in vec3 colors;

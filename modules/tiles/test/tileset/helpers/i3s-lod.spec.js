...
import {lodJudge} from '@loaders.gl/tiles/tileset/helpers/i3s-lod';
...
test('I3S LOD#lodJudge - should return "DIG" if lodMetric is 0 or NaN', (t) => {
  ...
  if (tileset.root) {
    const lodResult = lodJudge(tileset.root, frameState);
  ...
  const lodResult2 = lodJudge(tile2, frameState);

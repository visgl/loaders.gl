...
| `options.i3s.useFeatureIds`         | `Bool`           | `true`  | Add `featureIds` property in the tile content if available in geometry. `featureIds` specified in [tiles-3d-loader](https://loaders.gl/modules/3d-tiles/docs/api-reference/tiles-3d-loader) .                                                                                                                                   |

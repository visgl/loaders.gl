...
import decodedPolygonsGeometry from '@loaders.gl/mvt/test/results/decoded_mvt_polygons_array.json' assert {type: 'json'};

// GeoJSON Results
import decodedPointsGeoJSON from '@loaders.gl/mvt/test/results/decoded_mvt_points.json' assert {type: 'json'};
import decodedLinesGeoJSON from '@loaders.gl/mvt/test/results/decoded_mvt_lines.json' assert {type: 'json'};
import decodedPolygonsGeoJSON from '@loaders.gl/mvt/test/results/decoded_mvt_polygons.json' assert {type: 'json'};

// Rings
import ringsSingleRing from '@loaders.gl/mvt/test/data/rings_single_ring.json' assert {type: 'json'};
import ringsRingAndHole from '@loaders.gl/mvt/test/data/rings_ring_and_hole.json' assert {type: 'json'};
import ringsTwoRings from '@loaders.gl/mvt/test/data/rings_two_rings.json' assert {type: 'json'};
import ringsZeroSizeHole from '@loaders.gl/mvt/test/data/rings_zero_size_hole.json' assert {type: 'json'};

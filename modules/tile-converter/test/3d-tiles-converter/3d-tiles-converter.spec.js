...
// The test is flaky
// test('tile-converter(3d-tiles-converter)#converts i3s to 3d-tiles tileset', async (t) => {
//   if (!isBrowser) {
...
test('tile-converter(3d-tiles-converter)#should return error in browser environment', async (t) => {
  if (isBrowser) {
    const converter = new Tiles3DConverter();

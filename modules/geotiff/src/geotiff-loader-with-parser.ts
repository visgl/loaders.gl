...
const {preload: _GeoTIFFLoaderPreload, ...GeoTIFFLoaderMetadataWithoutPreload} =
  GeoTIFFLoaderMetadata;
...
/** GeoTIFF loader */
export const GeoTIFFLoaderWithParser = {
  ...GeoTIFFLoaderMetadataWithoutPreload,
  parse: parseGeoTIFF

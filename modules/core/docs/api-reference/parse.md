...
| `options.searchParams`           | object             | null       | Allows to set search params to URL. For example if url is `http://test.com` and searchParams are `{token: '12345', id:'54321'}` result will be `http://test.com/?token=12345&id=54321`.                           |

...
export {Tiles3DLoaderWithParser as Tiles3DLoader} from './tiles-3d-loader-with-parser';
export {CesiumIonLoaderWithParser as CesiumIonLoader} from './cesium-ion-loader-with-parser';

...
/*
Here is the version of getIdFromToken taken from deck.gl
We replace it with the function that returns Long instead of number
...
/*
  getGeoBounds is not exported in deck.gl.
  We use it outside of this file. So, export it!
*/
...
/*
Original function from deck.gl takes a token as a string or a number, which is wrong.
The token cannot be a number. It must be be a string. Otherwise leading zeros will be lost.

...
import {_getMemoryUsageGLTF, GLTFLoader, getGaussianSplatPrimitives, getVoxelPrimitives, postProcessGLTF} from '@loaders.gl/gltf';
...
export async function parseGltf3DTile(
  ...
  if (options?.['3d-tiles']?.loadGLTF) {
    ...
    tile.gaussianSplatPrimitives = gltfWithBuffers.gaussianSplatPrimitives || getGaussianSplatPrimitives(gltfWithBuffers);

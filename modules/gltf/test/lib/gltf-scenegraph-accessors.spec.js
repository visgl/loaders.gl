...
test.only('GLTFScenegraph#BufferView indices resolve correctly', async t => {
  ...
  t.equals(gltfScenegraph.getTypedArrayForBufferView(0).byteOffset, 2868, 'first bufferView offset correct');
  t.equals(gltfScenegraph.getTypedArrayForBufferView(1).byteOffset, 70432, 'second bufferView offset correct');

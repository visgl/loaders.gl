...
export type {GLTF_KHR_gaussian_splatting, GLTF_KHR_gaussian_splatting_compression_spz_2, GLTFGaussianSplatPrimitive} from './lib/types/gltf-ext-gaussian-splatting-schema';
...
export {name as KHR_GAUSSIAN_SPLATTING, SPZ_COMPRESSION_EXTENSION_NAME, getGaussianSplatPrimitives} from './lib/extensions/KHR_gaussian_splatting';

...
test('utf8 buffer to base64', function (t) {
  t.equal(
    new BufferPolyfill('Ձאab', 'utf8').toString('base64'),
    '1YHXkGFi'
  )
  t.end()
})
...
test('utf8 buffer to hex', function (t) {
  t.equal(
    new BufferPolyfill('Ձאab', 'utf8').toString('hex'),
    'd581d7906162'
  )
  t.end()
})
...
test('utf8 to utf8', function (t) {
  t.equal(
    new BufferPolyfill('öäüõÖÄÜÕ', 'utf8').toString('utf8'),
    'öäüõÖÄÜÕ'
  )
  t.end()
})
...
test('utf16le to utf16', function (t) {
  t.equal(
    new BufferPolyfill(new BufferPolyfill('abcd', 'utf8').toString('utf16le'), 'utf16le').toString('utf8'),
    'abcd'
  )
  t.end()
})
...
test('utf16le to utf16 with odd byte length input', function (t) {
  t.equal(
    new BufferPolyfill(new BufferPolyfill('abcde', 'utf8').toString('utf16le'), 'utf16le').toString('utf8'),
    'abcd'
  )
  t.end()
})
...
test('utf16le to hex', function (t) {
  t.equal(
    new BufferPolyfill('abcd', 'utf16le').toString('hex'),
    '6100620063006400'
  )
  t.end()
})
...
test('ascii buffer to base64', function (t) {
  t.equal(
    new BufferPolyfill('123456!@#$%^', 'ascii').toString('base64'),
    'MTIzNDU2IUAjJCVe'
  )
  t.end()
})
...
test('ascii buffer to hex', function (t) {
  t.equal(
    new BufferPolyfill('123456!@#$%^', 'ascii').toString('hex'),
...
test('base64 buffer to utf8', function (t) {
  t.equal(
    new BufferPolyfill('1YHXkGFi', 'base64').toString('utf8'),
    'Ձאab'
  )
  t.end()
})
...
test('hex buffer to utf8', function (t) {
  t.equal(
    new BufferPolyfill('d581d7906162', 'hex').toString('utf8'),
    'Ձאab'
  )
  t.end()
})
...
test('base64 buffer to ascii', function (t) {
  t.equal(
    new BufferPolyfill('MTIzNDU2IUAjJCVe', 'base64').toString('ascii'),
    '123456!@#$%^'
  )
  t.end()
})
...
test('hex buffer to ascii', function (t) {
  t.equal(
    new BufferPolyfill('31323334353621402324255e', 'hex').toString('ascii'),
    '123456!@#$%^'
  )
  t.end()
})
...
test('base64 buffer to binary', function (t) {
  t.equal(
    new BufferPolyfill('MTIzNDU2IUAjJCVe', 'base64').toString('binary'),
    '123456!@#$%^'
  )
  t.end()
})
...
test('hex buffer to binary', function (t) {
  t.equal(
    new BufferPolyfill('31323334353621402324255e', 'hex').toString('binary'),
    '123456!@#$%^'
  )
  t.end()
})
...
test('utf8 to binary', function (t) {
  /* jshint -W100 */
  t.equal(
    new BufferPolyfill('öäüõÖÄÜÕ', 'utf8').toString('binary'),
    'Ã¶Ã¤Ã¼ÃµÃÃÃÃ'
  )
  /* jshint +W100 */
  t.end()
...
test('utf8 replacement chars (1 byte sequence)', function (t) {
  t.equal(
    new BufferPolyfill([0x80]).toString(),
    '\uFFFD'
  )
  t.equal(
    new BufferPolyfill([0x7F]).toString(),
    '\u007F'
  )
  t.end()
})
...
test('utf8 replacement chars (2 byte sequences)', function (t) {
  t.equal(
    new BufferPolyfill([0xC7]).toString(),
    '\uFFFD'
  )
  t.equal(
    new BufferPolyfill([0xC7, 0xB1]).toString(),
    '\u01F1'
  )
  t.equal(
    new BufferPolyfill([0xC0, 0xB1]).toString(),
    '\uFFFD\uFFFD'
  )
  t.equal(
    new BufferPolyfill([0xC1, 0xB1]).toString(),
    '\uFFFD\uFFFD'
  )
  t.end()
})
...
test('utf8 replacement chars (3 byte sequences)', function (t) {
  t.equal(
    new BufferPolyfill([0xE0]).toString(),
    '\uFFFD'
  )
  t.equal(
    new BufferPolyfill([0xE0, 0xAC]).toString(),
    '\uFFFD\uFFFD'
  )
  t.equal(
    new BufferPolyfill([0xE0, 0xAC, 0xB9]).toString(),
    '\u0B39'
  )
  t.end()
})
...
test('utf8 replacement chars (4 byte sequences)', function (t) {
  t.equal(
    new BufferPolyfill([0xF4]).toString(),
    '\uFFFD'
  )
  t.equal(
    new BufferPolyfill([0xF4, 0x8F]).toString(),
    '\uFFFD\uFFFD'
  )
  t.equal(
    new BufferPolyfill([0xF4, 0x8F, 0x80]).toString(),
    '\uFFFD\uFFFD\uFFFD'
  )
  t.equal(
    new BufferPolyfill([0xF4, 0x8F, 0x80, 0x84]).toString(),
    '\uDBFC\uDC04'
  )
  t.equal(
    new BufferPolyfill([0xFF]).toString(),
    '\uFFFD'
  )
  t.equal(
    new BufferPolyfill([0xFF, 0x8F, 0x80, 0x84]).toString(),
    '\uFFFD\uFFFD\uFFFD\uFFFD'
  )
  t.end()
})
...
test('utf8 replacement chars for anything in the surrogate pair range', function (t) {
  t.equal(
    new BufferPolyfill([0xED, 0x9F, 0xBF]).toString(),
    '\uD7FF'
  )
  t.equal(
    new BufferPolyfill([0xED, 0xA0, 0x80]).toString(),
    '\uFFFD\uFFFD\uFFFD'
  )
  t.equal(
    new BufferPolyfill([0xED, 0xBE, 0x8B]).toString(),
    '\uFFFD\uFFFD\uFFFD'
  )
  t.equal(
    new BufferPolyfill([0xED, 0xBF, 0xBF]).toString(),
    '\uFFFD\uFFFD\uFFFD'
  )
  t.equal(
    new BufferPolyfill([0xEE, 0x80, 0x80]).toString(),
    '\uE000'
  )
  t.end()
})

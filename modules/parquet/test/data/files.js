const PARQUET_FILES = [
  {supported: false, title: 'alltypes_dictionary', path: 'good/alltypes_dictionary.parquet'},
  {supported: false, title: 'alltypes_plain', path: 'good/alltypes_plain.parquet'},
  ...
  {supported: false, title: 'nonnullable', path: 'good/nonnullable.impala.parquet'},
  ...
  {supported: false, title: 'uniform_encryption', path: 'good/uniform_encryption.parquet.encrypted'},

  // Encrypted
  {supported: false, bad: true, title: 'encrypt_columns_and_footer', path: 'encrypted/encrypt_columns_and_footer.parquet.encrypted'},
  {supported: false, bad: true, title: 'encrypt_columns_and_footer_aad', path: 'encrypted/encrypt_columns_and_footer_aad.parquet.encrypted'},
  {supported: false, bad: true, title: 'encrypt_columns_and_footer_ctr', path: 'encrypted/encrypt_columns_and_footer_ctr.parquet.encrypted'},
  {supported: false, bad: true, title: 'encrypt_columns_and_footer_disable_aad_storage', path: 'encrypted/encrypt_columns_and_footer_disable_aad_storage.parquet.encrypted'},
  {supported: false, bad: true,  title: 'encrypt_columns_plaintext_footer', path: 'encrypted/encrypt_columns_plaintext_footer.parquet.encrypted'},

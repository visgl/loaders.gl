...
export class ColumnIndex {
  ...
  public min_values: Array<Uint8Array>;
  public max_values: Array<Uint8Array>;
  ...
  public write(output: thrift.TProtocol): void {
    ...
    if (this.min_values != null) {
      ...
      this.min_values.forEach((value_2: Uint8Array): void => {
    ...
    if (this.max_values != null) {
      ...
      this.max_values.forEach((value_3: Uint8Array): void => {
  ...
  public static read(input: thrift.TProtocol): ColumnIndex {
    ...
    while (true) {
      ...
      switch (fieldId) {
        ...
        case 2:
          if (fieldType === thrift.Thrift.Type.LIST) {
            const value_7: Array<Uint8Array> = new Array<Uint8Array>();
            const metadata_2: thrift.TList = input.readListBegin();
            const size_2: number = metadata_2.size;
            for (let i_2: number = 0; i_2 < size_2; i_2++) {
              const value_8: Uint8Array = input.readBinary();
        ...
        case 3:
          if (fieldType === thrift.Thrift.Type.LIST) {
            const value_9: Array<Uint8Array> = new Array<Uint8Array>();
            const metadata_3: thrift.TList = input.readListBegin();
            const size_3: number = metadata_3.size;
            for (let i_3: number = 0; i_3 < size_3; i_3++) {
              const value_10: Uint8Array = input.readBinary();

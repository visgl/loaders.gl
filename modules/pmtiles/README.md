...
Vector tiles return Arrow tables with GeoArrow-compatible geometry by default. MLT tiles support the MLT decoder's `geojson-table`, `binary-geometry`, and `arrow-table` shapes;

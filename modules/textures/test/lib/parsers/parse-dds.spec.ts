...
const TEST_CASES = [
  ...
  },
  {
    ...
    format: GL_EXTENSIONS_CONSTANTS.COMPRESSED_RGBA_S3TC_DXT3_EXT
  },
  {
  ...
  },
  {
    ...
    format: GL_EXTENSIONS_CONSTANTS.COMPRESSED_RGB_ATC_WEBGL
  },
  {
    url: '@loaders.gl/textures/test/data/shannon-atc-rgba-explicit.dds',
    format: GL_EXTENSIONS_CONSTANTS.COMPRESSED_RGBA_ATC_EXPLICIT_ALPHA_WEBGL
  },
  {
    url: '@loaders.gl/textures/test/data/shannon-atc-rgba-interpolated.dds',
    format: GL_EXTENSIONS_CONSTANTS.COMPRESSED_RGBA_ATC_INTERPOLATED_ALPHA_WEBGL
  }
];

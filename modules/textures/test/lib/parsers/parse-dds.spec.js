...
const TEST_CASES = [
  {
    ...
    format: GL_EXTENSIONS.COMPRESSED_RGB_S3TC_DXT1_EXT
  },
  {
    url: '@loaders.gl/textures/test/data/shannon-dxt3.dds',
    format: GL_EXTENSIONS.COMPRESSED_RGBA_S3TC_DXT3_EXT
  },
  {
    url: '@loaders.gl/textures/test/data/shannon-dxt5.dds',
    format: GL_EXTENSIONS.COMPRESSED_RGBA_S3TC_DXT5_EXT
  },
  {
    url: '@loaders.gl/textures/test/data/shannon-atc-rgb.dds',
    format: GL_EXTENSIONS.COMPRESSED_RGB_ATC_WEBGL
  },
  {
    url: '@loaders.gl/textures/test/data/shannon-atc-rgba-explicit.dds',
    format: GL_EXTENSIONS.COMPRESSED_RGBA_ATC_EXPLICIT_ALPHA_WEBGL
  },
  {
    url: '@loaders.gl/textures/test/data/shannon-atc-rgba-interpolated.dds',
    format: GL_EXTENSIONS.COMPRESSED_RGBA_ATC_INTERPOLATED_ALPHA_WEBGL
  }
];

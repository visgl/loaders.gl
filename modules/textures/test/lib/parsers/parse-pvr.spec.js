...
import {GL_EXTENSIONS} from '../../../src/lib/gl-extensions';
...
const TEST_CASES = [
  {
    ...
    format: GL_EXTENSIONS.COMPRESSED_RGB_PVRTC_2BPPV1_IMG
  },
  {
    url: '@loaders.gl/textures/test/data/shannon-pvrtc-2bpp-rgba.pvr',
    format: GL_EXTENSIONS.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG
  },
  {
  ...
  },
  {
    ...
    format: GL_EXTENSIONS.COMPRESSED_RGBA_ASTC_10X10_KHR
  },
  {
    url: '@loaders.gl/textures/test/data/shannon-astc-srgb-10x10.pvr',
    format: GL_EXTENSIONS.COMPRESSED_SRGB8_ALPHA8_ASTC_10X10_KHR
  }
];

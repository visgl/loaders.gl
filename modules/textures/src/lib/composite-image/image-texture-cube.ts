...
export type ImageTextureCubeDirectionAlias =
  | 'right'
  | 'left'
  | 'top'
  | 'bottom'
...
export const IMAGE_TEXTURE_CUBE_FACES = [
  {face: GL_TEXTURE_CUBE_MAP_POSITIVE_X, name: '+X', direction: 'right', axis: 'x', sign: 'positive'},
  {face: GL_TEXTURE_CUBE_MAP_NEGATIVE_X, name: '-X', direction: 'left', axis: 'x', sign: 'negative'},
  {face: GL_TEXTURE_CUBE_MAP_POSITIVE_Y, name: '+Y', direction: 'top', axis: 'y', sign: 'positive'},
  {face: GL_TEXTURE_CUBE_MAP_NEGATIVE_Y, name: '-Y', direction: 'bottom', axis: 'y', sign: 'negative'},
  {face: GL_TEXTURE_CUBE_MAP_POSITIVE_Z, name: '+Z', direction: 'front', axis: 'z', sign: 'positive'},

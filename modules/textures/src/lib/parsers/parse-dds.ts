...
const DDS_PIXEL_FORMATS: Record<string, number> = {
  DXT1: GL_EXTENSIONS.COMPRESSED_RGB_S3TC_DXT1_EXT,
  DXT3: GL_EXTENSIONS.COMPRESSED_RGBA_S3TC_DXT3_EXT,
  DXT5: GL_EXTENSIONS.COMPRESSED_RGBA_S3TC_DXT5_EXT,
  'ATC ': GL_EXTENSIONS.COMPRESSED_RGB_ATC_WEBGL,
  ATCA: GL_EXTENSIONS.COMPRESSED_RGBA_ATC_EXPLICIT_ALPHA_WEBGL,
  ATCI: GL_EXTENSIONS.COMPRESSED_RGBA_ATC_INTERPOLATED_ALPHA_WEBGL
};

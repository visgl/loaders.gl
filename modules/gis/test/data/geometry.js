export default [
  ...
  },
  {
    binary: {
      ...
      pathIndices: {value: [0, 2, 4], size: 1},
      type: 'LineString'
    },
    geoJSON: {
  ...
  },
  {
    binary: {
      ...
      polygonIndices: {value: [0, 5], size: 1},
      primitivePolygonIndices: {value: [0, 5], size: 1},
      type: 'Polygon'
    },
    geoJSON: {
      type: 'Polygon',
  ...
  },
  {
    binary: {
      ...
      polygonIndices: {value: [0, 10], size: 1},
      primitivePolygonIndices: {value: [0, 5, 10], size: 1},
      type: 'Polygon'
    },
    geoJSON: {
      type: 'Polygon',
  ...
  },
  {
    binary: {
      ...
      polygonIndices: {value: [0, 5, 15], size: 1},
      primitivePolygonIndices: {value: [0, 5, 10, 15], size: 1},
      type: 'Polygon'
    },
    geoJSON: {
      type: 'MultiPolygon',

...
/*
export type Point2Separated = arrow.Struct<{x: arrow.Float64; y: arrow.Float64}>;
export type Point2Interleaved = arrow.Data<arrow.FixedSizeList<arrow.Float64>>['TType']

export const geoarrowFieldSeparatedCoordinate2 = new arrow.Field(
  'coordinate',
  new arrow.Struct([
...
export const geoarroFieldSeparatedCoordinate3 = new arrow.Field(
...
/*
export typeof geoarrowFieldInterleavedCoordinate2 = new arrow.Field(
  'interleaved-coordinate',
  new arrow.FixedSizeList(2, new arrow.Field('values', new arrow.Float64()))
);

export

export const geoarrowFieldInterleavedCoordinate3 = new arrow.Field(
  'interleaved-coordinate',
  new arrow.FixedSizeList(3, new arrow.Field('values', new arrow.Float64()))
);

export const geoarrowFieldInterleavedCoordinate4 = new arrow.Field(
  'interleaved-coordinate',
  new arrow.FixedSizeList(4, new arrow.Field('values', new arrow.Float64()))
);

export const geoarrowFieldPointInterleaved2 = new arrow.Field(
  'point',
  geoarrowFieldInterleavedCoordinate2.type
);

export const geoarrowFieldPointInterleaved3 = new arrow.Field(
  'point',
  geoarrowFieldInterleavedCoordinate3.type
);

export const geoarrowFieldPointInterleaved4 = new arrow.Field(
  'point',
  geoarrowFieldInterleavedCoordinate4.type
);

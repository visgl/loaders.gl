...
export const RADSourceLoader = {
  ...
  createDataSource: (data: string | Blob, options: RADSourceLoaderOptions): RADSource =>
    new RADSource(data, options)
} as const;
...
export class RADSource extends DataSource<string | Blob, RADSourceLoaderOptions> {
  ...
  constructor(data: string | Blob, options: RADSourceLoaderOptions) {
    super(data, options, RADSourceLoader.defaultOptions);

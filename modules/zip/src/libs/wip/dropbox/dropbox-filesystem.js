// Based on kepler.gl, Copyright (c) 2020 Uber Technologies, Inc.
// MIT license
...
const DEFAULT_DROPBOX_FOLDER_LINK = `//${DOMAIN}/home/Apps`;
...
export default class DropboxProvider extends Provider {
  constructor(clientId, appName) {
    ...
    this._folderLink = `${DEFAULT_DROPBOX_FOLDER_LINK}/${appName}`;
   ...
   */
  async writeFile({mapData, options = {}}) {
